...
const FORMAT_LIST: FormatList = [
	...
	},
	{
		...
		ruleset: ['Team Preview', 'Evasion Clause', 'Cancel Mod', 'Sleep Clause Mod', 'Fighting Clause', 'Authority Clause', 'Max Team Size = 6', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100', '+Unobtainable', '+Past'],
	},
	{
	...
	},
	{
		...
		debug: true,
		battle: { trunc: Math.trunc },
		ruleset: ['Team Preview', 'Sleep Clause Mod', 'Fighting Clause', 'Authority Clause', 'Evasion Moves Clause', 'Cancel Mod', 'Max Team Size = 6', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100', '+Unobtainable', '+Past'],
	},
	{
	...
	},
	{
		...
		debug: true,
		battle: { trunc: Math.trunc },
		ruleset: ['Team Preview', 'Evasion Clause', 'Sleep Clause Mod', 'Fighting Clause', 'Authority Clause', 'Cancel Mod', 'Max Team Size = 6', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100', '+Unobtainable', '+Past'],
	},
	{
	...
	},
	{
		...
		debug: true,
		battle: { trunc: Math.trunc },
		ruleset: ['Team Preview', 'Assign Roles', 'Picked Team Size = 6', 'Sleep Clause Mod', 'Fighting Clause', 'Authority Clause', 'Evasion Clause', 'Cancel Mod', 'Max Team Size = 6', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100', '+Unobtainable', '+Past'],
	},
	{
	...
	},
	{
		...
		debug: true,
		battle: { trunc: Math.trunc },
		ruleset: ['Team Preview', 'Evasion Clause', 'Cancel Mod', 'Sleep Clause Mod', 'Fighting Clause', 'Authority Clause', 'Max Team Size = 6', 'Picked Team Size = 4', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100', '+Unobtainable', '+Past'],
	},
	{
	...
	},
	{
		...
		debug: true,
		battle: { trunc: Math.trunc },
		ruleset: ['Team Preview', 'Sleep Clause Mod', 'Fighting Clause', 'Authority Clause', 'Evasion Clause', 'Cancel Mod', 'Max Team Size = 6', 'Picked Team Size = 3', 'Max Move Count = 4', 'Max Level = 100', 'Default Level = 100', '+Unobtainable', '+Past'],
	},
	{
