...
describe('Misty and Psychic Aura protections and direct boosts',()=>{
 ...
 it('Psychic Aura blocks opposing priority for grounded targets',()=>{const [p]=setup('rockyterrain');battle.field.setAura('psychicterrain',5,p);const hp=p.hp;battle.makeChoices('move splash','move quickattack');assert.equal(p.hp,hp);});
