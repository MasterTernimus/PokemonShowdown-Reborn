...
export const commands: Chat.ChatCommands = {
	tail(target, room, user) {
		this.checkBroadcast();
		this.sendReplyBox(customMoveList("Tail moves", move => !!move.flags['tail']));
	},
	tailhelp: ["/tail - Lists all Tail moves boosted by Whiplash."],
