...
export const Rulesets: import('../sim/dex-formats').FormatDataTable = {
	...
	standardag: {
		...
		ruleset: [
			'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Item Clause = 1',
		],
	},
	standard: {
		effectType: 'ValidatorRule',
	...
	hackmonsformelegality: {
		...
		onChangeSet(set, format, setHas, teamHas) {
			...
			if (
				...
				!['Eevee-Starter', 'Eevee-Starter-Alt', 'Floette-Eternal', 'Greninja-Ash', 'Pikachu-Starter', 'Xerneas-Neutral'].includes(species.name) &&
