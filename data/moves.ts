...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	aquastep: {
		...
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, kick: 1, dance: 1, metronome: 1 },
		secondary: {
			chance: 100,
			self: {
				boosts: {
		...
		condition: {
			...
			onSideStart(side) {
				if ((this.effectState?.duration ?? 5) > 5) {
					this.add('-sidestart', side, 'move: Arenite Wall', '[persistent]');
				} else {
	...
	blazekick: {
		...
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, kick: 1, metronome: 1 },
		critRatio: 2,
		secondary: {
			chance: 10,
			status: 'brn',
	...
	bulletseed: {
		...
		pp: 30,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, bullet: 1, arrow: 1 },
		multihit: [2, 5],
	...
	ceaselessedge: {
		...
		pp: 15,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1, slicing: 1, reflectable: 1, arrow: 1 },
	...
	drillpeck: {
		...
		pp: 20,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, distance: 1, drill: 1, metronome: 1 },
		critRatio: 2,
		target: "any",
		type: "Flying",
		contestType: "Cool",
	...
	fakeout: {
		...
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1 },
		onDisableMove(pokemon) {
			if (pokemon.activeMoveActions > 0) pokemon.disableMove('fakeout');
		},
		onTry(source) {
			if (source.activeMoveActions > 1) {
	...
	frenzyplant: {
		...
		pp: 5,
		priority: 0,
		flags: { recharge: 1, protect: 1, mirror: 1, nonsky: 1, metronome: 1, cantusetwice: 1 },
		onModifyMove(move, pokemon) {
			if (pokemon.getStat('atk', false, true) > pokemon.getStat('spa', false, true)) move.category = 'Physical';
		},
		onAfterMove(source, target, move) {
	...
	highjumpkick: {
		...
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, kick: 1, gravity: 1, metronome: 1 },
		hasCrashDamage: true,
		onMoveFail(target, source, move) {
			this.damage(source.baseMaxhp / 2, source, source, this.dex.conditions.get('High Jump Kick'));
		},
	...
	hornattack: {
		...
		pp: 25,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, horn: 1, metronome: 1 },
		secondary: {
			chance: 50,
			boosts: {
				def: -1,
	...
	hornleech: {
		...
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, horn: 1, heal: 1, metronome: 1 },
		drain: [1, 2],
		target: "normal",
		type: "Grass",
		contestType: "Tough",
	...
	hyperdrill: {
		...
		pp: 5,
		priority: 0,
		flags: { contact: 1, mirror: 1, drill: 1 },
		target: "normal",
		type: "Normal",
		contestType: "Clever",
	},
	...
	iciclespear: {
		...
		pp: 30,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, arrow: 1 },
		multihit: [2, 5],
		fullDamageSpread: true,
		target: "normal",
		type: "Ice",
	...
	meteorassault: {
		...
		pp: 5,
		priority: 0,
		flags: { recharge: 1, protect: 1, mirror: 1, failinstruct: 1, cantusetwice: 1 },
		onAfterMove(source, target, move) {
			if (target.fainted) {
				source.removeVolatile('mustrecharge');
			}
	...
	psychocut: {
		...
		pp: 20,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, slicing: 1, arrow: 1 },
		critRatio: 2,
		target: "normal",
		type: "Psychic",
		contestType: "Cool",
	...
	pyroball: {
		...
		pp: 5,
		priority: 0,
		flags: { protect: 1, mirror: 1, defrost: 1, kick: 1, bullet: 1 },
		secondary: {
			chance: 10,
			status: 'brn',
		},
	...
	snipeshot: {
		...
		pp: 15,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, pulse: 1, arrow: 1 },
		onModifyMove(move) {
	...
	stomp: {
		...
		pp: 20,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, nonsky: 1, kick: 1, metronome: 1 },
		secondary: {
			chance: 30,
			volatileStatus: 'flinch',
		},
	...
	thousandarrows: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, nonsky: 1, arrow: 1 },
		onEffectiveness(typeMod, target, type, move) {
	...
	thunderouskick: {
		...
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, kick: 1, mirror: 1 },
		secondary: {
			chance: 100,
			boosts: {
				def: -1,
	...
	thunderwave: {
		...
		flags: { protect: 1, reflectable: 1, mirror: 1, metronome: 1 },
		onModifyMove(move, source, target) {
			if (target && (source.hasType('Electric'))) {
				move.accuracy = 100;
			}
		},
		status: 'par',
