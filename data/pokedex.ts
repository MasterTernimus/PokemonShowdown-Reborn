export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	arcanine: {
		...
		evoItem: "Fire Stone",
		eggGroups: ["Field"],
		otherFormes: ["Arcanine-Hisui", "Arcanine-Aevian", "Arcanine-Alt"],
		formeOrder: ["Arcanine", "Arcanine-Hisui", "Arcanine-Aevian", "Arcanine-Alt"],
	},
	arcanineaevian: {
		num: 59,
	...
	typhlosionhisui: {
		...
		types: ["Fire", "Ghost"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 83, atk: 105, def: 80, spa: 137, spd: 65, spe: 100 },
	...
	flygon: {
		...
		evoLevel: 45,
		eggGroups: ["Bug", "Dragon"],
		otherFormes: ["Flygon-Mega-Z"],
		formeOrder: ["Flygon", "Flygon-Mega-Z"],
	},
	flygonmegaz: {
		num: 330,
		name: "Flygon-Mega-Z",
	...
	drapion: {
		...
		abilities: { 0: "Sniper", 1: "Merciless", H: "Strong Jaw" },
		heightm: 1.3,
		weightkg: 61.5,
		color: "Purple",
		prevo: "Skorupi",
	...
	sigilyph: {
		...
		abilities: { 0: "Tablets of Ruin", 1: "Magic Guard", H: "Tinted Lens" },
		heightm: 1.4,
		weightkg: 14,
		color: "Black",
		eggGroups: ["Flying"],
	...
	veluza: {
		...
		abilities: { 0: "Mold Breaker", 1: "Swift Swim", H: "Sharpness" },
		heightm: 2.5,
		weightkg: 90,
		color: "Gray",
		eggGroups: ["Water 2"],
...
const latestSpeciesUpdates: {[id: string]: any} = {
	...
	typhlosionhisui: {baseStats: {hp: 83, atk: 105, def: 80, spa: 137, spd: 65, spe: 95}},
