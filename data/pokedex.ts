export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	machamp: {
		...
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 100, atk: 145, def: 100, spa: 65, spd: 70, spe: 90 },
	...
	machampgmax: {
		...
		types: ["Fighting", "Dragon"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 150, atk: 145, def: 100, spa: 65, spd: 70, spe: 90 },
		abilities: { 0: "No Guard", 1: "Guts", H: "Fighting Fiend" },
		heightm: 25,
		weightkg: 0,
		color: "Gray",
	...
	lapras: {
		...
		otherFormes: ["Lapras-Gmax", "Lapras-Aevian", "Lapras-Azzy"],
		formeOrder: ["Lapras", "Lapras-Gmax", "Lapras-Aevian", "Lapras-Azzy"],
	},
	laprasgmax: {
		num: 131,
		name: "Lapras-Gmax",
	...
	hitmontop: {
		...
		gender: "M",
		baseStats: { hp: 80, atk: 130, def: 105, spa: 45, spd: 115, spe: 75 },
	...
	exploud: {
		...
		baseStats: { hp: 119, atk: 101, def: 73, spa: 116, spd: 73, spe: 88 },
