export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	dodrio: {
		...
		name: "Dodrio",
		types: ["Ground", "Flying"],
		baseStats: { hp: 80, atk: 130, def: 80, spa: 40, spd: 70, spe: 120 },
	...
	rhydon: {
		...
		name: "Rhydon",
		types: ["Ground", "Rock"],
		baseStats: { hp: 105, atk: 140, def: 130, spa: 45, spd: 65, spe: 30 },
	...
	tauros: {
		...
		abilities: { 0: "Intimidate", 1: "Anger Point", H: "Striker" },
		heightm: 1.4,
		weightkg: 88.4,
		color: "Brown",
	...
	rhyperior: {
		...
		name: "Rhyperior",
		types: ["Ground", "Rock"],
		baseStats: { hp: 115, atk: 150, def: 140, spa: 55, spd: 75, spe: 30 },
