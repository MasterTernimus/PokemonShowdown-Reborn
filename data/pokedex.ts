export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	hypno: {
		...
		name: "Hypno",
		types: ["Psychic", "Dark"],
		baseStats: { hp: 100, atk: 55, def: 95, spa: 60, spd: 140, spe: 50 },
	...
	absol: {
		...
		abilities: { 0: "Pressure", 1: "Super Luck", H: "Magic Bounce" },
		heightm: 1.2,
		weightkg: 47,
		color: "White",
		eggGroups: ["Field"],
	...
	ursalunabloodmoon: {
		...
		abilities: { 0: "Mind's Eye", 1: "Magic Guard", H: "Shadow Shield" },
		heightm: 2.7,
		weightkg: 333,
		color: "Brown",
		eggGroups: ["Field"],
