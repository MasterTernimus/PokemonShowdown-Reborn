export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	rapidash: {
		...
		abilities: { 0: "Run Away", 1: "Speed Boost", H: "Striker" },
		heightm: 1.7,
		weightkg: 95,
		color: "Yellow",
		prevo: "Ponyta",
	...
	typhlosion: {
		...
		abilities: { 0: "Flash Fire", 1: "Drought", H: "Sand Rush" },
		heightm: 1.7,
		weightkg: 79.5,
		color: "Yellow",
		prevo: "Quilava",
	...
	typhlosionhisui: {
		...
		abilities: { 0: "Blaze", 1: "Soul Fire", H: "Shadow Shield" },
		heightm: 1.6,
		weightkg: 69.8,
		color: "Yellow",
		prevo: "Quilava",
	...
	pyroar: {
		...
		abilities: { 0: "Punk Rock", 1: "Unnerve", H: "Competitive" },
		heightm: 1.5,
		weightkg: 81.5,
		color: "Brown",
		prevo: "Litleo",
