...
export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	venusaurmega: {
		...
		types: ["Grass", "Poison"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 60, def: 143, spa: 122, spd: 140, spe: 80 },
		abilities: { 0: "Toxic Bloom" },
		heightm: 2.4,
		weightkg: 155.5,
		color: "Green",
		eggGroups: ["Monster", "Grass"],
	...
	venusaurgmax: {
		...
		types: ["Grass", "Poison"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 136, atk: 82, def: 83, spa: 100, spd: 100, spe: 80 },
		abilities: { 0: "Ancient Bloom" },
		heightm: 24,
		weightkg: 0,
		color: "Green",
		eggGroups: ["Monster", "Grass"],
	...
	charizard: {
		...
		formeOrder: ["Charizard", "Charizard-Mega-X", "Charizard-Mega-Y", "Charizard-Alt"],
	...
	charizardmegax: {
		...
		types: ["Fire", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 78, atk: 135, def: 110, spa: 120, spd: 106, spe: 105 },
	...
	charizardmegay: {
		...
		types: ["Fire", "Flying"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 78, atk: 90, def: 100, spa: 160, spd: 116, spe: 110 },
		abilities: { 0: "Sun Sovereign" },
		heightm: 1.7,
		weightkg: 100.5,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
	...
	butterfree: {
		...
		name: "Butterfree",
		types: ["Bug", "Flying"],
		baseStats: { hp: 75, atk: 38, def: 71, spa: 108, spd: 93, spe: 90 },
		abilities: { 0: "Compound Eyes", 1: "Shield Dust", H: "Magic Guard" },
		heightm: 1.1,
		weightkg: 32,
		color: "White",
		prevo: "Metapod",
	...
	butterfreegmax: {
		...
		forme: "Gmax",
		types: ["Bug", "Fairy"],
		baseStats: { hp: 112, atk: 38, def: 71, spa: 108, spd: 93, spe: 90 },
		abilities: { 0: "Corrosive Scale" },
		heightm: 17,
		weightkg: 0,
		color: "White",
		eggGroups: ["Bug"],
	...
	beedrill: {
		...
		name: "Beedrill",
		types: ["Bug", "Poison"],
		baseStats: { hp: 65, atk: 110, def: 55, spa: 45, spd: 80, spe: 120 },
		abilities: { 0: "Levitate", 1: "Dual Wield", H: "Sniper" },
		heightm: 1,
		weightkg: 29.5,
		color: "Yellow",
		prevo: "Kakuna",
	...
	beedrillmega: {
		...
		forme: "Mega",
		types: ["Bug", "Poison"],
		baseStats: { hp: 65, atk: 150, def: 75, spa: 45, spd: 80, spe: 160 },
		abilities: { 0: "Spiral Evolution" },
		heightm: 1.4,
		weightkg: 40.5,
		color: "Yellow",
		eggGroups: ["Bug"],
	...
	pikachu: {
		...
		otherFormes: ["Pikachu-Cosplay", "Pikachu-Rock-Star", "Pikachu-Belle", "Pikachu-Pop-Star", "Pikachu-PhD", "Pikachu-Libre", "Pikachu-Original", "Pikachu-Hoenn", "Pikachu-Sinnoh", "Pikachu-Unova", "Pikachu-Kalos", "Pikachu-Alola", "Pikachu-Partner", "Pikachu-Starter", "Pikachu-World", "Pikachu-Gmax"],
		formeOrder: [
			"Pikachu",
	...
	raichualola: {
		...
		baseStats: { hp: 60, atk: 85, def: 50, spa: 95, spd: 85, spe: 120 },
		abilities: { 0: "Surge Surfer", 1: "Levitate", H: "Inner Focus" },
		heightm: 0.7,
		weightkg: 21,
		color: "Brown",
		prevo: "Pikachu",
	...
	raichumegay: {
		...
		forme: "Mega-Y",
		types: ["Electric"],
		baseStats: { hp: 60, atk: 100, def: 55, spa: 160, spd: 80, spe: 140 },
		abilities: { 0: "Railgun Circuit" },
		heightm: 1,
		weightkg: 26,
		color: "Yellow",
		eggGroups: ["Field", "Fairy"],
	...
	nidoking: {
		...
		abilities: { 0: "Royal Decree", 1: "Sheer Force", H: "Royal Armament" },
		heightm: 1.4,
		weightkg: 62,
		color: "Purple",
		prevo: "Nidorino",
	...
	clefairy: {
		...
		abilities: { 0: "Pastel Veil", 1: "Magic Guard", H: "Friend Guard" },
		heightm: 0.6,
		weightkg: 7.5,
		color: "Pink",
		prevo: "Cleffa",
	...
	clefable: {
		...
		types: ["Fairy"],
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 100, atk: 50, def: 95, spa: 95, spd: 113, spe: 55 },
		abilities: { 0: "Moon Veil", 1: "Magic Guard", H: "Unaware" },
		heightm: 1.3,
		weightkg: 40,
		color: "Pink",
		prevo: "Clefairy",
	...
	clefablemega: {
		...
		types: ["Fairy", "Flying"],
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 100, atk: 80, def: 95, spa: 135, spd: 110, spe: 88 },
		abilities: { 0: "Lunar Orbit" },
		heightm: 1.7,
		weightkg: 42.3,
		color: "Pink",
		eggGroups: ["Field"],
	...
	vileplume: {
		...
		name: "Vileplume",
		types: ["Grass", "Poison"],
		baseStats: { hp: 90, atk: 75, def: 95, spa: 120, spd: 100, spe: 50 },
		abilities: { 0: "Chlorophyll", 1: "Storm Drain", H: "Toxic Sink" },
		heightm: 1.2,
		weightkg: 18.6,
		color: "Red",
		prevo: "Gloom",
	...
	parasectmega: {
		...
		forme: "Mega",
		types: ["Ghost", "Bug"],
		baseStats: { hp: 90, atk: 140, def: 130, spa: 30, spd: 130, spe: 60 },
		abilities: { 0: "Complete Parasitism" },
		heightm: 1,
		weightkg: 29.5,
		color: "Red",
		eggGroups: ["Bug", "Grass"],
		requiredItem: "Parasectite",
		battleOnly: "Parasect",
		gen: 9,
	},
	venonat: {
	...
	meowthgmax: {
		...
		forme: "Gmax",
		types: ["Normal"],
		baseStats: { hp: 60, atk: 45, def: 35, spa: 40, spd: 40, spe: 90 },
		abilities: { 0: "Pickup", 1: "Technician", H: "Unnerve" },
		heightm: 33,
		weightkg: 0,
		color: "Yellow",
	...
	growlithe: {
		...
		abilities: { 0: "Flash Fire", 1: "Guard Dog", H: "Intimidate" },
		heightm: 0.7,
		weightkg: 19,
		color: "Brown",
		evos: ["Arcanine"],
	...
	arcanine: {
		...
		abilities: { 0: "Living Legend", 1: "Vanguard", H: "Drought", S: "Battle Bond" },
		heightm: 1.9,
		weightkg: 155,
		color: "Brown",
		prevo: "Growlithe",
		...
		evoItem: "Fire Stone",
		eggGroups: ["Field"],
		otherFormes: ["Arcanine-Hisui", "Arcanine-Aevian", "Arcanine-Alt", "Arcanine-Battle-Bond"],
		formeOrder: ["Arcanine", "Arcanine-Hisui", "Arcanine-Aevian", "Arcanine-Alt", "Arcanine-Battle-Bond"],
	},
	arcanineaevian: {
		num: 59,
		name: "Arcanine-Aevian",
		baseSpecies: "Arcanine-Aevian",
		forme: "Aevian",
	...
	arcaninehisui: {
		...
		types: ["Fire", "Rock"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 110, atk: 135, def: 115, spa: 40, spd: 105, spe: 95 },
		abilities: { 0: "Intimidate", 1: "Stamina", H: "Hisuian Resolve", S: "Battle Bond" },
		heightm: 2,
		weightkg: 168,
		color: "Brown",
	...
	arcaninebattlebond: {
		num: 59,
		name: "Arcanine-Battle-Bond",
		baseSpecies: "Arcanine",
		forme: "Battle-Bond",
		types: ["Fire"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 90, atk: 150, def: 105, spa: 125, spd: 105, spe: 125 },
		abilities: { 0: "Sacred Bond" },
		heightm: 1.9,
		weightkg: 155,
		color: "Blue",
		eggGroups: ["Field"],
	...
	alakazam: {
		...
		cosmeticFormes: ["Alakazam-Alt"],
		formeOrder: ["Alakazam", "Alakazam-Mega", "Alakazam-Alt"],
	},
	alakazammega: {
		num: 65,
		name: "Alakazam-Mega",
	...
	machamp: {
		...
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 100, atk: 140, def: 105, spa: 65, spd: 85, spe: 75 },
		abilities: { 0: "Guts", 1: "Stamina", H: "Fighting Fiend" },
		heightm: 1.6,
		weightkg: 130,
		color: "Gray",
		prevo: "Machoke",
		...
		cosmeticFormes: ["Machamp-Alt"],
		formeOrder: ["Machamp", "Machamp-Alt"],
	},
	machampalt: {
	...
	machampgmax: {
		...
		types: ["Fighting", "Dragon"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 150, atk: 140, def: 105, spa: 65, spd: 85, spe: 75 },
		abilities: { 0: "Raging Fists", 1: "Stamina", H: "Guts" },
		heightm: 25,
		weightkg: 0,
		color: "Gray",
		eggGroups: ["Human-Like"],
		changesFrom: "Machamp",
		cosmeticFormes: ["Machamp-Gmax-Alt"],
		formeOrder: ["Machamp-Gmax", "Machamp-Gmax-Alt"],
	},
	machampgmaxalt: {
		isCosmeticForme: true,
		num: 68,
	...
	victreebel: {
		...
		abilities: { 0: "Chlorophyll", 1: "Accumulation", H: "Gluttony" },
		heightm: 1.7,
		weightkg: 15.5,
		color: "Green",
		prevo: "Weepinbell",
	...
	victreebelmega: {
		...
		forme: "Mega",
		types: ["Grass", "Poison"],
		baseStats: { hp: 100, atk: 125, def: 95, spa: 135, spd: 105, spe: 70 },
		abilities: { 0: "Solar Trap" },
		heightm: 4.5,
		weightkg: 125.5,
		color: "Green",
		eggGroups: ["Grass"],
	...
	tentacruel: {
		...
		name: "Tentacruel",
		types: ["Water", "Poison"],
		baseStats: { hp: 80, atk: 70, def: 75, spa: 90, spd: 120, spe: 105 },
		abilities: { 0: "Liquid Ooze", 1: "Regenerator", H: "Water Absorb" },
		heightm: 1.6,
		weightkg: 55,
		color: "Blue",
		prevo: "Tentacool",
	...
	geodude: {
		...
		abilities: { 0: "Sturdy", 1: "Bulletproof", H: "Brute Force" },
		heightm: 0.4,
		weightkg: 20,
		color: "Brown",
		evos: ["Graveler"],
	...
	golem: {
		...
		name: "Golem",
		types: ["Rock", "Ground"],
		baseStats: { hp: 100, atk: 120, def: 130, spa: 55, spd: 65, spe: 70 },
		abilities: { 0: "Sturdy", 1: "Bulletproof", H: "Brute Force" },
		heightm: 1.4,
		weightkg: 300,
		color: "Brown",
	...
	magneton: {
		...
		types: ["Electric", "Steel"],
		gender: "N",
		baseStats: { hp: 70, atk: 60, def: 95, spa: 120, spd: 70, spe: 85 },
		abilities: { 0: "Paradox Pull", 1: "Elevate", H: "Hydra Bond" },
		heightm: 1,
		weightkg: 60,
		color: "Gray",
		prevo: "Magnemite",
	...
	dewgong: {
		...
		name: "Dewgong",
		types: ["Water", "Ice"],
		baseStats: { hp: 90, atk: 100, def: 70, spa: 100, spd: 95, spe: 90 },
		abilities: { 0: "Snow Warning", 1: "Ice Scales", H: "Fur Coat" },
		heightm: 1.7,
		weightkg: 120,
		color: "White",
		prevo: "Seel",
	...
	gastly: {
		...
		abilities: { 0: "Levitate", 1: "Infiltrator", H: "Bad Dreams" },
		heightm: 1.3,
		weightkg: 0.1,
		color: "Purple",
		evos: ["Haunter"],
	...
	gengar: {
		...
		name: "Gengar",
		types: ["Ghost", "Poison"],
		baseStats: { hp: 70, atk: 65, def: 60, spa: 130, spd: 85, spe: 110 },
		abilities: { 0: "Shadow Shield", 1: "Levitate", H: "Bad Dreams" },
		heightm: 1.5,
		weightkg: 40.5,
		color: "Purple",
		prevo: "Haunter",
	...
	gengarmega: {
		...
		forme: "Mega",
		types: ["Ghost", "Poison"],
		baseStats: { hp: 70, atk: 65, def: 80, spa: 170, spd: 105, spe: 130 },
		abilities: { 0: "Cruel Tag" },
		heightm: 1.4,
		weightkg: 40.5,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	gengargmax: {
		...
		forme: "Gmax",
		types: ["Ghost", "Poison"],
		baseStats: { hp: 120, atk: 65, def: 60, spa: 130, spd: 85, spe: 110 },
	...
	krabby: {
		...
		abilities: { 0: "Hyper Cutter", 1: "Anger Shell", H: "Sheer Force" },
		heightm: 0.4,
		weightkg: 6.5,
		color: "Red",
		evos: ["Kingler"],
	...
	voltorb: {
		...
		abilities: { 0: "Soundproof", 1: "Battery", H: "Aftermath" },
		heightm: 0.5,
		weightkg: 10.4,
		color: "Red",
		evos: ["Electrode"],
	...
	electrode: {
		...
		types: ["Electric", "Fire"],
		gender: "N",
		baseStats: { hp: 60, atk: 50, def: 75, spa: 110, spd: 75, spe: 150 },
	...
	exeggutor: {
		...
		name: "Exeggutor",
		types: ["Grass", "Psychic"],
		baseStats: { hp: 95, atk: 95, def: 100, spa: 125, spd: 100, spe: 55 },
		abilities: { 0: "Chlorophyll", 1: "Orchard Bond", H: "Invigorate" },
		heightm: 2,
		weightkg: 120,
		color: "Yellow",
		prevo: "Exeggcute",
	...
	exeggutoralola: {
		...
		forme: "Alola",
		types: ["Grass", "Dragon"],
		baseStats: { hp: 95, atk: 105, def: 100, spa: 125, spd: 100, spe: 45 },
		abilities: { 0: "Frisk", 1: "Orchard Bond", H: "Invigorate" },
		heightm: 10.9,
		weightkg: 415.6,
		color: "Yellow",
		prevo: "Exeggcute",
	...
	marowak: {
		...
		abilities: { 0: "Mold Breaker", 1: "Lightning Rod", H: "Bone Warrior" },
		heightm: 1,
		weightkg: 45,
		color: "Brown",
		prevo: "Cubone",
	...
	marowakalola: {
		...
		types: ["Fire", "Ghost"],
		baseStats: { hp: 75, atk: 80, def: 110, spa: 50, spd: 80, spe: 60 },
		abilities: { 0: "Lightning Rod", 1: "Bone Warrior", H: "Soul Fire" },
		heightm: 1,
		weightkg: 34,
		color: "Purple",
		prevo: "Cubone",
	...
	hitmonlee: {
		...
		abilities: { 0: "Unburden", 1: "Ultra Instinct", H: "Kick Fiend" },
		heightm: 1.5,
		weightkg: 49.8,
		color: "Brown",
		prevo: "Tyrogue",
	...
	hitmonchan: {
		...
		gender: "M",
		baseStats: { hp: 80, atk: 130, def: 89, spa: 40, spd: 120, spe: 81 },
		abilities: { 0: "Scrappy", 1: "Ultra Ego", H: "Punch Fiend" },
		heightm: 1.4,
		weightkg: 50.2,
		color: "Brown",
		prevo: "Tyrogue",
	...
	weezing: {
		...
		abilities: { 0: "Elevate", 1: "Neutralizing Gas", H: "Accumulation" },
		heightm: 1.2,
		weightkg: 9.5,
		color: "Purple",
		prevo: "Koffing",
	...
	weezinggalar: {
		...
		types: ["Poison", "Fairy"],
		baseStats: { hp: 65, atk: 90, def: 120, spa: 85, spd: 70, spe: 60 },
		abilities: { 0: "Elevate", 1: "Neutralizing Gas", H: "Misty Surge" },
		heightm: 3,
		weightkg: 16,
		color: "Gray",
		prevo: "Koffing",
	...
	rhydon: {
		...
		name: "Rhydon",
		types: ["Ground", "Rock"],
		baseStats: { hp: 110, atk: 140, def: 130, spa: 35, spd: 75, spe: 60 },
		abilities: { 0: "Lightning Rod", 1: "War Path", H: "Power Drill" },
		heightm: 1.9,
		weightkg: 120,
		color: "Gray",
		prevo: "Rhyhorn",
	...
	chansey: {
		...
		abilities: { 0: "Natural Cure", 1: "Serene Grace", H: "Invigorate" },
		heightm: 1.1,
		weightkg: 34.6,
		color: "Pink",
		prevo: "Happiny",
	...
	tangela: {
		...
		abilities: { 0: "Chlorophyll", 1: "Invigorate", H: "Regenerator" },
		heightm: 1,
		weightkg: 35,
		color: "Blue",
		evos: ["Tangrowth"],
	...
	kangaskhan: {
		...
		abilities: { 0: "Scrappy", 1: "Friend Guard", H: "Inner Focus" },
		heightm: 2.2,
		weightkg: 80,
		color: "Brown",
		eggGroups: ["Monster"],
	...
	seaking: {
		...
		name: "Seaking",
		types: ["Water","Steel"],
		baseStats: { hp: 80, atk: 110, def: 75, spa: 55, spd: 90, spe: 90 },
		abilities: { 0: "Lightning Rod", 1: "Power Drill", H: "Drizzle" },
		heightm: 1.3,
		weightkg: 39,
		color: "Red",
		prevo: "Goldeen",
	...
	starmie: {
		...
		types: ["Water", "Psychic"],
		gender: "N",
		baseStats: { hp: 60, atk: 75, def: 85, spa: 105, spd: 85, spe: 115 },
		abilities: { 0: "Illuminate", 1: "Natural Cure", H: "Victory Star" },
		heightm: 1.1,
		weightkg: 80,
		color: "Purple",
		prevo: "Staryu",
	...
	scyther: {
		...
		abilities: { 0: "Swarm", 1: "Technician", H: "Dual Wield" },
		heightm: 1.5,
		weightkg: 56,
		color: "Green",
		evos: ["Scizor", "Kleavor"],
	...
	electabuzz: {
		...
		abilities: { 0: "Static", 1: "Vital Spirit", H: "Electromorphosis" },
		heightm: 1.1,
		weightkg: 30,
		color: "Yellow",
		prevo: "Elekid",
	...
	tauros: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: { hp: 85, atk: 110, def: 105, spa: 40, spd: 90, spe: 110 },
		abilities: { 0: "Bull Rush", 1: "Gluttony", H: "Ultra Ego" },
		heightm: 1.4,
		weightkg: 88.4,
		color: "Brown",
	...
	taurospaldeacombat: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: { hp: 85, atk: 120, def: 115, spa: 30, spd: 90, spe: 100 },
		abilities: { 0: "Bull Rush", 1: "Gluttony", H: "Guts" },
		heightm: 1.4,
		weightkg: 115,
		color: "Black",
		eggGroups: ["Field"],
	...
	taurospaldeablaze: {
		...
		gender: "M",
		baseStats: { hp: 85, atk: 120, def: 115, spa: 30, spd: 90, spe: 100 },
		abilities: { 0: "Bull Rush", 1: "Gluttony", H: "Flame Body" },
		heightm: 1.4,
		weightkg: 85,
		color: "Black",
		eggGroups: ["Field"],
	...
	taurospaldeaaqua: {
		...
		gender: "M",
		baseStats: { hp: 85, atk: 120, def: 115, spa: 30, spd: 90, spe: 100 },
		abilities: { 0: "Bull Rush", 1: "Gluttony", H: "Thick Fat" },
		heightm: 1.4,
		weightkg: 110,
		color: "Black",
		eggGroups: ["Field"],
	...
	gyarados: {
		...
		name: "Gyarados",
		types: ["Water", "Flying"],
		baseStats: { hp: 95, atk: 125, def: 84, spa: 80, spd: 105, spe: 81 },
		abilities: { 0: "Intimidate", 1: "Dragonize", H: "Moxie" },
		heightm: 6.5,
		weightkg: 235,
		color: "Blue",
		prevo: "Magikarp",
	...
	gyaradosaevian: {
		...
		forme: "Aevian",
		types: ["Fire", "Dragon"],
		baseStats: { hp: 95, atk: 80, def: 84, spa: 125, spd: 105, spe: 81 },
		abilities: { 0: "Multiscale", 1: "Competitive", H: "Intimidate" },
		heightm: 6.5,
		weightkg: 235,
		color: "Red",
		eggGroups: ["Water 2", "Dragon"],
		otherFormes: ["Gyarados-Aevian-Mega"],
		formeOrder: ["Gyarados-Aevian", "Gyarados-Aevian-Mega"],
		isNonstandard: "Custom",
	},
	gyaradosaevianmega: {
		num: 130,
		name: "Gyarados-Aevian-Mega",
		baseSpecies: "Gyarados-Aevian",
		forme: "Mega-Aevian",
		types: ["Fire", "Dragon"],
		baseStats: { hp: 95, atk: 90, def: 114, spa: 155, spd: 135, spe: 81 },
		abilities: { 0: "Helios" },
		heightm: 6.5,
		weightkg: 235,
		color: "Red",
		...
		battleOnly: "Gyarados-Aevian",
		changesFrom: "Gyarados-Aevian",
		isMega: true,
		isNonstandard: "Custom",
	},
	gyaradosmega: {
		...
		forme: "Mega",
		types: ["Water", "Dark"],
		baseStats: { hp: 95, atk: 155, def: 114, spa: 90, spd: 135, spe: 81 },
		abilities: { 0: "Unleashed Ego" },
		heightm: 6.5,
		weightkg: 305,
		color: "Blue",
		eggGroups: ["Water 2", "Dragon"],
	...
	lapras: {
		...
		name: "Lapras",
		types: ["Water", "Ice"],
		baseStats: { hp: 130, atk: 85, def: 90, spa: 95, spd: 105, spe: 65 },
		...
		otherFormes: ["Lapras-Gmax", "Lapras-Azzy"],
		formeOrder: ["Lapras", "Lapras-Gmax", "Lapras-Azzy"],
	},
	laprasgmax: {
		num: 131,
		name: "Lapras-Gmax",
		...
		forme: "Gmax",
		types: ["Water", "Ice"],
		baseStats: { hp: 195, atk: 85, def: 90, spa: 95, spd: 105, spe: 65 },
		abilities: { 0: "Aurora Resonance" },
		heightm: 24,
		weightkg: 0,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	laprasaevian: {
		...
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
		canGigantamax: "G-Max Echo Resonance",
		otherFormes: ["Lapras-Aevian-Gmax"],
		formeOrder: ["Lapras-Aevian", "Lapras-Aevian-Gmax"],
		isNonstandard: "Custom",
	},
	laprasaeviangmax: {
		num: 131,
		name: "Lapras-Aevian-Gmax",
	...
	eeveestarter: {
		...
		types: ["Normal"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 130, atk: 90, def: 70, spa: 100, spd: 85, spe: 70 },
	...
	eeveegmax: {
		...
		types: ["Normal"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 150, atk: 75, def: 70, spa: 65, spd: 85, spe: 75 },
		abilities: { 0: "Fluffy Evo" },
		heightm: 18,
		weightkg: 0,
		color: "Brown",
		eggGroups: ["Field"],
	...
	vaporeon: {
		...
		abilities: { 0: "Tidal Wave", 1: "Marvel Scale", H: "Drizzle" },
		heightm: 1,
		weightkg: 29,
		color: "Blue",
		prevo: "Eevee",
	...
	jolteon: {
		...
		abilities: { 0: "Livewire", 1: "Battery", H: "Electric Surge" },
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: "Eevee",
	...
	flareon: {
		...
		abilities: { 0: "Kindled Fury", 1: "Fire Mane", H: "Drought" },
		heightm: 0.9,
		weightkg: 25,
		color: "Red",
		prevo: "Eevee",
	...
	omastar: {
		...
		types: ["Rock", "Water"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 40, def: 130, spa: 125, spd: 90, spe: 70 },
		abilities: { 0: "Swift Swim", 1: "Mega Launcher", H: "Relic Armor" },
		heightm: 1,
		weightkg: 35,
		color: "Blue",
		prevo: "Omanyte",
	...
	kabutops: {
		...
		types: ["Rock", "Water"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 65, atk: 125, def: 120, spa: 40, spd: 90, spe: 90 },
		abilities: { 0: "Swift Swim", 1: "Sharpness", H: "Relic Armor" },
		heightm: 1.3,
		weightkg: 40.5,
		color: "Brown",
		prevo: "Kabuto",
	...
	aerodactylmega: {
		...
		types: ["Rock", "Flying"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 135, def: 105, spa: 80, spd: 100, spe: 150 },
	...
	snorlaxgmax: {
		...
		types: ["Normal", "Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 240, atk: 125, def: 90, spa: 40, spd: 125, spe: 30 },
		abilities: { 0: "Mountain Hunger" },
		heightm: 35,
		weightkg: 0,
		color: "Black",
		eggGroups: ["Monster"],
	...
	articuno: {
		...
		abilities: { 0: "Pressure", 1: "Ice Scales" },
		heightm: 1.7,
		weightkg: 55.4,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	chikorita: {
		...
		abilities: { 0: "Overgrow", H: "Invigorate" },
		heightm: 0.9,
		weightkg: 6.4,
		color: "Green",
		evos: ["Bayleef"],
	...
	meganium: {
		...
		types: ["Grass", "Fairy"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 62, def: 115, spa: 73, spd: 125, spe: 70 },
		abilities: { 0: "Triage", 1: "Verdant Hospitality", H: "Invigorate" },
		heightm: 1.8,
		weightkg: 100.5,
		color: "Green",
		prevo: "Bayleef",
	...
	typhlosion: {
		...
		types: ["Fire", "Ground"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 83, atk: 95, def: 85, spa: 112, spd: 70, spe: 100 },
		abilities: { 0: "Blazing Mane", 1: "Drought", H: "Sand Rush" },
		heightm: 1.7,
		weightkg: 79.5,
		color: "Yellow",
		prevo: "Quilava",
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Typhlosion-Hisui", "Typhlosion-Alt", "Typhlosion-Mega"],
		formeOrder: ["Typhlosion", "Typhlosion-Hisui", "Typhlosion-Alt", "Typhlosion-Mega"],
	},
	typhlosionalt: {
		num: 157,
		name: "Typhlosion-Alt",
	...
	typhlosionhisui: {
		...
		types: ["Fire", "Ghost"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 83, atk: 95, def: 80, spa: 127, spd: 65, spe: 95 },
	...
	typhlosionmega: {
		...
		types: ["Fire", "Electric"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 83, atk: 138, def: 85, spa: 139, spd: 70, spe: 130 },
		abilities: { 0: "Plasma Eruption" },
		heightm: 1.7,
		weightkg: 79.5,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	feraligatr: {
		...
		canGigantamax: "G-Max Death Roll",
	},
	feraligatrmega: {
		num: 160,
	...
	noctowl: {
		...
		name: "Noctowl",
		types: ["Dark", "Flying"],
		baseStats: {"hp":100,"atk":50,"def":78,"spa":96,"spd":106,"spe":80},
		abilities: { 0: "Duskilate", 1: "Co-Star", H: "Lunar Spirit" },
		heightm: 1.6,
		weightkg: 40.8,
		color: "Brown",
		prevo: "Hoothoot",
	...
	ariados: {
		...
		name: "Ariados",
		types: ["Bug", "Poison"],
		baseStats: {"hp":80,"atk":100,"def":85,"spa":75,"spd":85,"spe":40},
	...
	xatu: {
		...
		name: "Xatu",
		types: ["Psychic", "Flying"],
		baseStats: { hp: 65, atk: 75, def: 90, spa: 105, spd: 90, spe: 105 },
		abilities: { 0: "Temporal Shift", 1: "Neutralization", H: "Magic Bounce" },
		heightm: 1.5,
		weightkg: 15,
		color: "Green",
		prevo: "Natu",
	...
	mareep: {
		...
		abilities: { 0: "Static", 1: "Plus", H: "Fluffy" },
		heightm: 0.6,
		weightkg: 7.8,
		color: "White",
		evos: ["Flaaffy"],
	...
	ampharosaevian: {
		...
		forme: "Aevian",
		types: ["Ice", "Electric"],
		baseStats: { hp: 110, atk: 75, def: 90, spa: 115, spd: 85, spe: 55 },
		abilities: { 0: "Ice Scales", 1: "Fluffy", H: "Filter" },
		heightm: 1.4,
		weightkg: 61.5,
		color: "Blue",
		eggGroups: ["Monster", "Field"],
		otherFormes: ["Ampharos-Aevian-Mega"],
		formeOrder: ["Ampharos-Aevian", "Ampharos-Aevian-Mega"],
		isNonstandard: "Custom",
	},
	ampharosaevianmega: {
		num: 181,
		name: "Ampharos-Aevian-Mega",
		baseSpecies: "Ampharos-Aevian",
		forme: "Mega-Aevian",
		types: ["Ice", "Electric"],
		...
		eggGroups: ["Monster", "Field"],
		requiredItem: "Ampharosite",
		battleOnly: "Ampharos-Aevian",
		changesFrom: "Ampharos-Aevian",
		isMega: true,
		isNonstandard: "Custom",
	},
	bellossom: {
	...
	politoed: {
		...
		name: "Politoed",
		types: ["Water"],
		baseStats: { hp: 110, atk: 75, def: 80, spa: 100, spd: 100, spe: 70 },
		abilities: { 0: "Water Absorb", 1: "Royal Decree", H: "Drizzle" },
		heightm: 1.1,
		weightkg: 33.9,
		color: "Green",
		prevo: "Poliwhirl",
	...
	hoppip: {
		...
		abilities: { 0: "Chlorophyll", 1: "Invigorate", H: "Infiltrator" },
		heightm: 0.4,
		weightkg: 0.5,
		color: "Pink",
		evos: ["Skiploom"],
	...
	jumpluff: {
		...
		name: "Jumpluff",
		types: ["Grass", "Flying"],
		baseStats: { hp: 75, atk: 70, def: 95, spa: 55, spd: 105, spe: 110 },
		abilities: { 0: "Chlorophyll", 1: "Wind Rider", H: "Windy Surge" },
		heightm: 0.8,
		weightkg: 3,
		color: "Blue",
		prevo: "Skiploom",
	...
	sunkern: {
		...
		abilities: { 0: "Chlorophyll", 1: "Solar Power", H: "Seed Sower" },
		heightm: 0.3,
		weightkg: 1.8,
		color: "Yellow",
		evos: ["Sunflora"],
	...
	sunflora: {
		...
		name: "Sunflora",
		types: ["Grass", "Fire"],
		baseStats: { hp: 95, atk: 55, def: 75, spa: 125, spd: 90, spe: 30 },
		abilities: { 0: "Flash Fire", 1: "Solar Power", H: "Grassy Surge" },
		heightm: 0.8,
		weightkg: 8.5,
		color: "Yellow",
		prevo: "Sunkern",
	...
	sunfloramega: {
		...
		forme: "Mega",
		types: ["Grass", "Fire"],
		baseStats: {hp: 95, atk: 70, def: 105, spa: 155, spd: 115, spe: 30},
		abilities: {0: "Solar Hydra"},
		heightm: 0.8,
		weightkg: 8.5,
		color: "Yellow",
		eggGroups: ["Grass"],
	...
	espeon: {
		...
		abilities: { 0: "Trace", 1: "Magic Bounce", H: "Telepathy", S: "Mind Freeze", E: "Eclipse" },
		heightm: 0.9,
		weightkg: 26.5,
		color: "Purple",
		prevo: "Eevee",
	...
	umbreon: {
		...
		abilities: { 0: "Poison Heal", 1: "Inner Focus", H: "Pressure", S: "Eclipse", G: "Ascendance" },
		heightm: 1,
		weightkg: 27,
		color: "Black",
		prevo: "Eevee",
		...
		evoCondition: "at night",
		eggGroups: ["Field"],
		otherFormes: ["Umbreon-Perfect"],
		formeOrder: ["Umbreon", "Umbreon-Perfect"],
	},
	umbreonperfect: {
		num: 197,
	...
	slowking: {
		...
		abilities: { 0: "Neutralization", 1: "Own Tempo", H: "Regenerator" },
		heightm: 2,
		weightkg: 79.5,
		color: "Pink",
		prevo: "Slowpoke",
	...
	forretress: {
		...
		abilities: { 0: "Overcoat", 1: "Heatproof", H: "Aftermath" },
		heightm: 1.2,
		weightkg: 125.8,
		color: "Purple",
		prevo: "Pineco",
	...
	gligar: {
		...
		evos: ["Gliscor"],
		eggGroups: ["Bug"],
		otherFormes: ["Gligar-Alt"],
		cosmeticFormes: ["Gligar-Alt"],
		formeOrder: ["Gligar", "Gligar-Alt"],
	},
	steelix: {
		num: 208,
		name: "Steelix",
		...
		abilities: { 0: "Brute Force", 1: "Whiplash", H: "Heavy Metal" },
		heightm: 9.2,
		weightkg: 400,
		color: "Gray",
		prevo: "Onix",
	...
	qwilfish: {
		...
		abilities: { 0: "Accumulation", 1: "Swift Swim", H: "Intimidate" },
		heightm: 0.5,
		weightkg: 3.9,
		color: "Gray",
		eggGroups: ["Water 2"],
	...
	qwilfishhisui: {
		...
		types: ["Dark", "Poison"],
		baseStats: { hp: 65, atk: 95, def: 85, spa: 55, spd: 55, spe: 85 },
		abilities: { 0: "Toxic Debris", 1: "Swift Swim", H: "Intimidate" },
		heightm: 0.5,
		weightkg: 3.9,
		color: "Black",
		evos: ["Overqwil"],
	...
	scizormega: {
		...
		abilities: { 0: "Technical Specialist" },
		heightm: 2,
		weightkg: 125,
		color: "Red",
		eggGroups: ["Bug"],
	...
	heracross: {
		...
		abilities: { 0: "Violent Rush", 1: "Guts", H: "Moxie" },
		heightm: 1.5,
		weightkg: 54,
		color: "Blue",
		eggGroups: ["Bug"],
	...
	sneasel: {
		...
		abilities: { 0: "Inner Focus", 1: "Sharpness", H: "Pickpocket" },
		heightm: 0.9,
		weightkg: 28,
		color: "Black",
		evos: ["Weavile"],
	...
	magcargo: {
		...
		name: "Magcargo",
		types: ["Fire", "Rock"],
		baseStats: { hp: 70, atk: 50, def: 120, spa: 110, spd: 80, spe: 30 },
		abilities: { 0: "Dry Skin", 1: "Berserk", H: "Earth Eater" },
		heightm: 0.8,
		weightkg: 55,
		color: "Red",
		prevo: "Slugma",
	...
	octillery: {
		...
		abilities: { 0: "Dual Wield", 1: "Sniper", H: "No Guard" },
		heightm: 0.9,
		weightkg: 28.5,
		color: "Red",
		prevo: "Remoraid",
	...
	delibird: {
		...
		name: "Delibird",
		types: ["Ice", "Flying"],
		baseStats: { hp: 75, atk: 124, def: 75, spa: 10, spd: 80, spe: 136 },
		abilities: { 0: "Prankster", 1: "Evil Santa", H: "Friend Guard" },
		heightm: 0.9,
		weightkg: 16,
		color: "Red",
		eggGroups: ["Water 1", "Field"],
	...
	mantine: {
		...
		abilities: { 0: "Swift Swim", 1: "Water Absorb", H: "Friend Guard" },
		heightm: 2.1,
		weightkg: 220,
		color: "Purple",
		prevo: "Mantyke",
	...
	houndour: {
		...
		abilities: { 0: "Insomnia", 1: "Flash Fire", H: "Unnerve" },
		heightm: 0.6,
		weightkg: 10.8,
		color: "Black",
		evos: ["Houndoom"],
	...
	donphan: {
		...
		abilities: { 0: "Aevian Frost", 1: "Stamina", H: "Paradox Wheel" },
		heightm: 1.1,
		weightkg: 120,
		color: "Gray",
		prevo: "Phanpy",
		evoLevel: 25,
		eggGroups: ["Field"],
		otherFormes: ["Donphan-Rejuv"],
		formeOrder: ["Donphan", "Donphan-Rejuv"],
	},
	donphanrejuv: {
		num: 232, name: "Donphan-Rejuv", baseSpecies: "Donphan", forme: "Rejuv",
		types: ["Ice", "Ground"],
		baseStats: { hp: 120, atk: 120, def: 115, spa: 50, spd: 60, spe: 45 },
		abilities: { 0: "Aevian Frost" },
		heightm: 1.1, weightkg: 120, color: "Brown", eggGroups: ["Field"],
		requiredAbility: "Aevian Frost", battleOnly: "Donphan", isNonstandard: "Custom",
	},
	porygon2: {
		num: 233,
		name: "Porygon2",
		types: ["Normal"],
		gender: "N",
		baseStats: { hp: 85, atk: 80, def: 95, spa: 110, spd: 100, spe: 60 },
		abilities: { 0: "Trace", 1: "Defragment", H: "Memory Leak" },
		heightm: 0.6,
		weightkg: 32.5,
		color: "Red",
		prevo: "Porygon",
	...
	hitmontop: {
		...
		gender: "M",
		baseStats: { hp: 80, atk: 120, def: 105, spa: 45, spd: 115, spe: 75 },
		abilities: { 0: "Contrary", 1: "Intimidate", H: "Spin Fiend" },
		heightm: 1.4,
		weightkg: 48,
		color: "Brown",
		prevo: "Tyrogue",
	...
	smoochum: {
		...
		abilities: { 0: "Dazzling", 1: "Forewarn", H: "Dry Skin" },
		heightm: 0.4,
		weightkg: 6,
		color: "Pink",
		evos: ["Jynx"],
	...
	tyranitar: {
		...
		abilities: { 0: "Sand Stream", 1: "Solid Rock", H: "Shed Skin" },
		heightm: 2,
		weightkg: 202,
		color: "Green",
		prevo: "Pupitar",
	...
	sceptile: {
		...
		types: ["Grass", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 70, atk: 105, def: 60, spa: 115, spd: 60, spe: 120 },
		abilities: { 0: "Regenerator", 1: "Dual Wield", H: "Unburden" },
		heightm: 1.7,
		weightkg: 52.2,
		color: "Green",
		prevo: "Grovyle",
	...
	sceptilemega: {
		...
		types: ["Grass", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 70, atk: 130, def: 70, spa: 145, spd: 70, spe: 145 },
		abilities: { 0: "Verdant Drake" },
		heightm: 1.9,
		weightkg: 55.2,
		color: "Green",
		eggGroups: ["Monster", "Dragon"],
	...
	blaziken: {
		...
		abilities: { 0: "Defiant", 1: "Striker", H: "Speed Boost" },
		heightm: 1.9,
		weightkg: 52,
		color: "Red",
		prevo: "Combusken",
	...
	swampert: {
		...
		abilities: { 0: "Dry Skin", 1: "Regenerator", H: "Damp" },
		heightm: 1.5,
		weightkg: 81.9,
		color: "Blue",
		prevo: "Marshtomp",
	...
	swampertmega: {
		...
		types: ["Water", "Ground"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 100, atk: 150, def: 120, spa: 65, spd: 120, spe: 80 },
		abilities: { 0: "Raging Current" },
		heightm: 1.9,
		weightkg: 102,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	linoone: {
		...
		abilities: { 0: "Pickup", 1: "Scrappy", H: "Quick Feet" },
		heightm: 0.5,
		weightkg: 32.5,
		color: "White",
		prevo: "Zigzagoon",
	...
	ludicolo: {
		...
		abilities: { 0: "Swift Swim", 1: "Liquid Voice", H: "Own Tempo" },
		heightm: 1.5,
		weightkg: 55,
		color: "Green",
		prevo: "Lombre",
	...
	shiftry: {
		...
		name: "Shiftry",
		types: ["Grass", "Dark"],
		baseStats: { hp: 90, atk: 110, def: 70, spa: 90, spd: 60, spe: 80 },
	...
	pelipper: {
		...
		abilities: { 0: "Accumulation", 1: "Drizzle", H: "Rain Dish" },
		heightm: 1.2,
		weightkg: 28,
		color: "Yellow",
		prevo: "Wingull",
	...
	gardevoir: {
		cosmeticFormes: ["Gardevoir-Void"],
		num: 282,
		name: "Gardevoir",
		types: ["Psychic", "Fairy"],
		baseStats: { hp: 75, atk: 60, def: 65, spa: 125, spd: 115, spe: 100 },
	...
	gardevoirmega: {
		cosmeticFormes: ["Gardevoir-Mega-Alt"],
		num: 282,
		name: "Gardevoir-Mega",
	...
	gardevoirmegaz: {
		...
		baseSpecies: "Gardevoir",
		forme: "Mega",
		spriteid: "gardevoir-megaz",
		types: ["Steel", "Fairy"],
		baseStats: { hp: 75, atk: 144, def: 65, spa: 125, spd: 80, spe: 151 },
		abilities: { 0: "Argent Devotion" },
		heightm: 1.6,
		weightkg: 48.4,
		color: "White",
		eggGroups: ["Amorphous"],
		requiredItem: "Shiny Stone",
	},
	gardevoirvoidmega: {
		num: 282,
		...
		baseSpecies: "Gardevoir",
		forme: "Void-Mega",
		spriteid: "gardevoirvoid-mega",
		types: ["Fairy", "Dark"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 175, spd: 160, spe: 120 },
	...
	breloommega: {"num":286,"name":"Breloom-Mega","baseSpecies":"Breloom","forme":"Mega","types":["Poison","Fighting"],"baseStats":{"hp":80,"atk":160,"def":90,"spa":55,"spd":105,"spe":110},"abilities":{"0":"Corrosive Touch"},"heightm":1.2,"weightkg":39.2,"color":"Purple","eggGroups":["Fairy","Grass"],"requiredItem":"Breloomite","battleOnly":["Breloom","Breloom-Rejuv"],"isNonstandard":"Custom"},
	breloom: {
		otherFormes: ["Breloom-Rejuv", "Breloom-Mega"],
		formeOrder: ["Breloom", "Breloom-Rejuv", "Breloom-Mega"],
		num: 286,
		name: "Breloom",
		types: ["Grass", "Fighting"],
		baseStats: {"hp":80,"atk":130,"def":80,"spa":60,"spd":80,"spe":70},
		abilities: { 0: "Mold Breaker", 1: "Poison Heal", H: "Technician", S: "Aevian Spark" },
		heightm: 1.2,
		weightkg: 39.2,
		color: "Green",
		prevo: "Shroomish",
	...
	breloomrejuv: {
		...
		baseStats: {hp: 80, atk: 130, def: 80, spa: 60, spd: 80, spe: 70},
		abilities: {0: "Aevian Spark"},
		heightm: 1.2,
		weightkg: 39.2,
		color: "Black",
		eggGroups: ["Fairy", "Grass"],
		requiredAbility: "Aevian Spark",
		battleOnly: "Breloom",
		isNonstandard: "Custom",
	},
	slakoth: {
	...
	whismur: {
		...
		abilities: { 0: "Soundproof", 1: "Punk Rock", H: "Rattled" },
		heightm: 0.6,
		weightkg: 16.3,
		color: "Pink",
		evos: ["Loudred"],
	...
	exploud: {
		...
		baseStats: { hp: 119, atk: 101, def: 73, spa: 106, spd: 73, spe: 78 },
		abilities: { 0: "Conductivity", 1: "Scrappy", H: "Resonance Force" },
		heightm: 1.5,
		weightkg: 84,
		color: "Blue",
		prevo: "Loudred",
	...
	hariyama: {
		...
		types: ["Fighting"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 134, atk: 120, def: 88, spa: 40, spd: 88, spe: 50 },
	...
	delcatty: {
		...
		abilities: { 0: "Cute Charm", 1: "Fur Coat", H: "Wonder Skin" },
		heightm: 1.1,
		weightkg: 32.6,
		color: "Purple",
		prevo: "Skitty",
	...
	mawile: {
		...
		name: "Mawile",
		types: ["Steel", "Fairy"],
		baseStats: { hp: 70, atk: 45, def: 115, spa: 55, spd: 75, spe: 50 },
		abilities: { 0: "Huge Power", 1: "Intimidate", H: "Accumulation" },
		heightm: 0.6,
		weightkg: 11.5,
		color: "Black",
		eggGroups: ["Field", "Fairy"],
	...
	aggron: {
		...
		name: "Aggron",
		types: ["Steel", "Rock"],
		baseStats: { hp: 70, atk: 100, def: 160, spa: 100, spd: 70, spe: 30 },
		abilities: { 0: "Lightning Rod", 1: "Brute Force", H: "Heavy Metal" },
		heightm: 2.1,
		weightkg: 360,
		color: "Gray",
		prevo: "Lairon",
	...
	medicham: {
		...
		name: "Medicham",
		types: ["Fighting", "Psychic"],
		baseStats: { hp: 80, atk: 100, def: 75, spa: 60, spd: 75, spe: 80 },
		abilities: { 0: "Pure Power", 1: "Unburden", H: "Limber" },
		heightm: 1.3,
		weightkg: 31.5,
		color: "Red",
		prevo: "Meditite",
	...
	medichammega: {
		...
		forme: "Mega",
		types: ["Fighting", "Psychic"],
		baseStats: { hp: 80, atk: 100, def: 100, spa: 95, spd: 85, spe: 110 },
		abilities: { 0: "Enlightenment" },
		heightm: 1.3,
		weightkg: 31.5,
		color: "Red",
		eggGroups: ["Human-Like"],
	...
	manectric: {
		...
		abilities: { 0: "Galvanize", 1: "Competitive", H: "Lightning Rod" },
		heightm: 1.5,
		weightkg: 40.2,
		color: "Yellow",
		prevo: "Electrike",
	...
	plusle: {
		...
		baseStats: { hp: 70, atk: 40, def: 60, spa: 105, spd: 85, spe: 90 },
		abilities: { 0: "Battery", 1: "Lightning Rod", H: "Friend Guard" },
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		eggGroups: ["Fairy"],
	...
	minun: {
		...
		baseStats: { hp: 70, atk: 40, def: 60, spa: 95, spd: 105, spe: 80 },
		abilities: { 0: "Battery", 1: "Lightning Rod", H: "Symbiosis" },
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		eggGroups: ["Fairy"],
	...
	roselia: {
		...
		abilities: { 0: "Natural Cure", 1: "Poison Point", H: "Invigorate" },
		heightm: 0.3,
		weightkg: 2,
		color: "Green",
		prevo: "Budew",
	...
	swalot: {
		...
		name: "Swalot",
		types: ["Water", "Poison"],
		baseStats: { hp: 120, atk: 75, def: 105, spa: 85, spd: 110, spe: 35 },
		abilities: { 0: "Liquid Ooze", 1: "Neutralization", H: "Accumulation" },
		heightm: 1.7,
		weightkg: 80,
		color: "Purple",
		prevo: "Gulpin",
	...
	sharpedomegay: {
		...
		forme: "Mega-Y",
		types: ["Water", "Steel"],
		baseStats: { hp: 70, atk: 40, def: 125, spa: 150, spd: 125, spe: 90 },
		abilities: { 0: "Apex Armor" },
		heightm: 2.5,
		weightkg: 130.3,
		color: "Blue",
		eggGroups: ["Water 2"],
	...
	wailmer: {
		...
		abilities: { 0: "Liquid Voice", 1: "Water Veil", H: "Pressure" },
		heightm: 2,
		weightkg: 130,
		color: "Blue",
		evos: ["Wailord"],
	...
	wailord: {
		...
		name: "Wailord",
		types: ["Water","Psychic"],
		baseStats: { hp: 160, atk: 40, def: 75, spa: 105, spd: 90, spe: 50 },
		abilities: { 0: "Drizzle", 1: "Stamina", H: "Pressure" },
		heightm: 14.5,
		weightkg: 398,
		color: "Blue",
		prevo: "Wailmer",
	...
	trapinch: {
		...
		abilities: { 0: "Earth Eater", 1: "Arena Trap", H: "Sheer Force" },
		heightm: 0.7,
		weightkg: 15,
		color: "Brown",
		evos: ["Vibrava"],
	...
	vibrava: {
		...
		abilities: { 0: "Levitate", 1: "Dragonize", H: "Sandstream" },
		heightm: 1.1,
		weightkg: 15.3,
		color: "Green",
		prevo: "Trapinch",
	...
	flygon: {
		...
		abilities: { 0: "Levitate", 1: "Resonance Force", H: "Sandstream" },
		heightm: 2,
		weightkg: 82,
		color: "Green",
		prevo: "Vibrava",
		evoLevel: 45,
		eggGroups: ["Bug", "Dragon"],
		otherFormes: ["Flygon-Mega", "Flygon-Mega-Z"],
		formeOrder: ["Flygon", "Flygon-Mega", "Flygon-Mega-Z"],
	},
	flygonmega: {
		num: 330,
		name: "Flygon-Mega",
		...
		forme: "Mega",
		types: ["Dragon", "Bug"],
		baseStats: { hp: 80, atk: 100, def: 85, spa: 135, spd: 85, spe: 135 },
	...
	flygonmegaz: {
		...
		forme: "Mega-Z",
		types: ["Ground", "Dragon"],
		baseStats: { hp: 80, atk: 149, def: 80, spa: 80, spd: 80, spe: 151 },
		abilities: { 0: "Tremor" },
		heightm: 2,
		weightkg: 82,
		color: "Green",
	...
	altariamega: {
		...
		forme: "Mega",
		types: ["Dragon", "Fairy"],
		baseStats: { hp: 85, atk: 110, def: 110, spa: 110, spd: 105, spe: 100 },
		abilities: { 0: "Heavenly Chorus" },
		heightm: 1.5,
		weightkg: 20.6,
		color: "Blue",
		eggGroups: ["Flying", "Dragon"],
	...
	zangoose: {
		...
		baseStats: { hp: 75, atk: 130, def: 80, spa: 60, spd: 70, spe: 95 },
		...
		formeOrder: ["Zangoose", "Zangoose-Mega"],
	},
	seviper: {
		num: 336,
		name: "Seviper",
		types: ["Poison", "Dark"],
		baseStats: { hp: 75, atk: 110, def: 70, spa: 90, spd: 70, spe: 95 },
		abilities: { 0: "Apex Venom", 1: "Whiplash", H: "Accumulation" },
		heightm: 2.7,
		weightkg: 52.5,
		color: "Black",
		eggGroups: ["Field", "Dragon"],
	...
	zangoosemega: {
		...
		forme: "Mega",
		types: ["Normal", "Steel"],
		baseStats: { hp: 75, atk: 155, def: 125, spa: 70, spd: 90, spe: 95 },
		abilities: { 0: "Toxic Armor" },
		heightm: 1.3,
		weightkg: 40.3,
		color: "White",
		eggGroups: ["Field"],
	...
	sevipermega: {
		...
		forme: "Mega",
		types: ["Poison", "Dragon"],
		baseStats: { hp: 75, atk: 140, def: 115, spa: 70, spd: 115, spe: 95 },
		abilities: { 0: "Sirius" },
		heightm: 2.7,
		weightkg: 52.5,
		color: "Black",
	...
	lunatone: {
		...
		types: ["Rock", "Ghost"],
		gender: "N",
		baseStats: { hp: 110, atk: 35, def: 95, spa: 125, spd: 95, spe: 70 },
		abilities: { 0: "Lunar Idol", 1: "Ice Scales", H: "Shadow Shield" },
		heightm: 1,
		weightkg: 168,
		color: "Yellow",
		eggGroups: ["Mineral"],
	...
	solrock: {
		...
		types: ["Rock", "Steel"],
		gender: "N",
		baseStats: { hp: 110, atk: 125, def: 95, spa: 35, spd: 95, spe: 70 },
		abilities: { 0: "Solar Idol", 1: "Dauntless Shield", H: "Full Metal Body" },
		heightm: 1.2,
		weightkg: 154,
		color: "Red",
		eggGroups: ["Mineral"],
	...
	whiscash: {
		...
		name: "Whiscash",
		types: ["Water", "Ground"],
		baseStats: { hp: 110, atk: 98, def: 103, spa: 98, spd: 71, spe: 60 },
		abilities: { 0: "Sap Sipper", 1: "Unaware", H: "Earth Eater" },
		heightm: 0.9,
		weightkg: 23.6,
		color: "Blue",
		prevo: "Barboach",
	...
	claydol: {
		...
		abilities: { 0: "Levitate", 1: "Relic Beam", H: "Defragment" },
		heightm: 1.5,
		weightkg: 108,
		color: "Black",
		prevo: "Baltoy",
		evoLevel: 36,
		eggGroups: ["Mineral"],
		otherFormes: ["Claydol-Mega"],
		formeOrder: ["Claydol", "Claydol-Mega"],
	},
	claydolmega: {
		num: 344,
		name: "Claydol-Mega",
		...
		types: ["Ground", "Psychic"],
		gender: "N",
		baseStats: { hp: 60, atk: 70, def: 135, spa: 130, spd: 150, spe: 55 },
		abilities: { 0: "Astral Engine" },
		heightm: 1.5,
		weightkg: 108,
		color: "Black",
		eggGroups: ["Mineral"],
		requiredItem: "Claydolite",
		gen: 9,
	},
	lileep: {
		num: 345,
	...
	cradily: {
		...
		types: ["Rock", "Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 95, atk: 75, def: 120, spa: 85, spd: 130, spe: 25 },
		abilities: { 0: "Storm Drain", 1: "Relic Armor", H: "Accumulation" },
		heightm: 1.5,
		weightkg: 60.4,
		color: "Green",
		prevo: "Lileep",
	...
	anorith: {
		...
		abilities: { 0: "Battle Armor", 1: "Swift Swim", H: "Anger Shell" },
		heightm: 0.7,
		weightkg: 12.5,
		color: "Gray",
		evos: ["Armaldo"],
	...
	armaldo: {
		...
		types: ["Rock", "Bug"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 145, def: 120, spa: 30, spd: 105, spe: 55 },
		abilities: { 0: "Relic Armor", 1: "Swift Swim", H: "Skill Link" },
		heightm: 1.5,
		weightkg: 68.2,
		color: "Gray",
		prevo: "Anorith",
	...
	milotic: {
		...
		name: "Milotic",
		types: ["Water", "Fairy"],
		baseStats: { hp: 95, atk: 80, def: 84, spa: 105, spd: 125, spe: 81 },
		...
		evoItem: "Prism Scale",
		eggGroups: ["Water 1", "Dragon"],
		otherFormes: ["Milotic-Mega", "Milotic-Terajuma"],
		formeOrder: ["Milotic", "Milotic-Mega", "Milotic-Terajuma"],
	},
	miloticterajuma: {
		num: 350,
		name: "Milotic-Terajuma",
		baseSpecies: "Milotic",
		forme: "Terajuma",
		types: ["Water", "Rock"],
		baseStats: { hp: 109, atk: 119, def: 84, spa: 62, spd: 105, spe: 91 },
		abilities: { 0: "Prism Scale", 1: "Whiplash", H: "Queenly Majesty" },
		heightm: 6.2,
		weightkg: 162,
		color: "Blue",
		eggGroups: ["Water 1", "Dragon"],
	...
	miloticmega: {
		...
		forme: "Mega",
		types: ["Water", "Dragon"],
		baseStats: { hp: 95, atk: 90, def: 114, spa: 135, spd: 155, spe: 81 },
		abilities: { 0: "Royal Scales" },
		heightm: 6.2,
		weightkg: 162,
		color: "Pink",
		eggGroups: ["Water 1", "Dragon"],
		requiredItem: "Miloticide",
		battleOnly: "Milotic",
		changesFrom: "Milotic",
	},
	miloticaevian: {
		...
		name: "Milotic-Aevian",
		types: ["Poison", "Fairy"],
		baseStats: { hp: 95, atk: 105, def: 84, spa: 80, spd: 125, spe: 81 },
	...
	castform: {
		...
		name: "Castform",
		types: ["Normal"],
		baseStats: { hp: 100, atk: 70, def: 70, spa: 70, spd: 70, spe: 110 },
		abilities: { 0: "Forecast", 1: "Memory Leak" },
		heightm: 0.3,
		weightkg: 0.8,
		color: "Gray",
		eggGroups: ["Fairy", "Amorphous"],
		otherFormes: ["Castform-Sunny", "Castform-Rainy", "Castform-Snowy", "Castform-Sandy", "Castform-Windy"],
		formeOrder: ["Castform", "Castform-Sunny", "Castform-Rainy", "Castform-Snowy", "Castform-Sandy", "Castform-Windy"],
	},
	castformsunny: {
		num: 351,
		name: "Castform-Sunny",
		...
		forme: "Sunny",
		types: ["Fire"],
		baseStats: { hp: 100, atk: 70, def: 80, spa: 110, spd: 80, spe: 110 },
		abilities: { 0: "Forecast", 1: "Memory Leak" },
		heightm: 0.3,
		weightkg: 0.8,
		color: "Red",
	...
	tropius: {
		...
		name: "Tropius",
		types: ["Grass", "Flying"],
		baseStats: { hp: 115, atk: 90, def: 95, spa: 75, spd: 95, spe: 70 },
		abilities: { 0: "Harvest", 1: "Hospitality", H: "Windy Surge" },
		heightm: 2,
		weightkg: 100,
		color: "Green",
		eggGroups: ["Monster", "Grass"],
	...
	absol: {
		...
		name: "Absol",
		types: ["Dark", "Fairy"],
		baseStats: { hp: 65, atk: 130, def: 65, spa: 75, spd: 65, spe: 100 },
		abilities: { 0: "Pressure", 1: "Sword of Ruin", H: "Magic Bounce" },
		heightm: 1.2,
		weightkg: 47,
		color: "White",
		eggGroups: ["Field"],
	...
	absolmega: {
		...
		forme: "Mega",
		types: ["Dark", "Fairy"],
		baseStats: { hp: 65, atk: 105, def: 65, spa: 175, spd: 65, spe: 125 },
		abilities: { 0: "Doom Warning" },
		heightm: 1.2,
		weightkg: 49,
		color: "White",
		eggGroups: ["Field"],
	...
	absolmegaz: {
		...
		forme: "Mega-Z",
		types: ["Dark", "Ghost"],
		baseStats: { hp: 65, atk: 154, def: 75, spa: 85, spd: 70, spe: 151 },
		abilities: { 0: "Omen Edge" },
		heightm: 1.2,
		weightkg: 49,
		color: "Black",
		eggGroups: ["Field"],
	...
	baseStats: { hp: 80, atk: 80, def: 80, spa: 80, spd: 95, spe: 105 },
		abilities: { 0: "Inner Focus", 1: "Strong Jaw", H: "Intimidate" },
		heightm: 1.5,
		weightkg: 256.5,
		color: "Gray",
		prevo: "Snorunt",
	...
	glaliemega: {
		...
		forme: "Mega",
		types: ["Ice", "Fire"],
		baseStats: { hp: 70, atk: 140, def: 100, spa: 80, spd: 90, spe: 120 },
		abilities: { 0: "Freezer Burn" },
		heightm: 2.1,
		weightkg: 350.2,
		color: "Gray",
		eggGroups: ["Fairy", "Mineral"],
	...
	glalieaevian: {
		num: 362,
		name: "Glalie-Aevian",
		baseSpecies: "Glalie-Aevian",
		forme: "Aevian",
		types: ["Grass", "Rock"],
		baseStats: { hp: 110, atk: 110, def: 100, spa: 50, spd: 80, spe: 50 },
		abilities: { 0: "Grassy Surge", 1: "Brute Force", H: "Stamina" },
		heightm: 1.5,
		weightkg: 256.5,
		color: "Green",
		eggGroups: ["Fairy", "Mineral"],
		otherFormes: ["Glalie-Aevian-Mega"],
		formeOrder: ["Glalie-Aevian", "Glalie-Aevian-Mega"],
		isNonstandard: "Custom",
	},
	glalieaevianmega: {
		num: 362,
		name: "Glalie-Aevian-Mega",
		baseSpecies: "Glalie-Aevian",
		forme: "Mega-Aevian",
		types: ["Grass", "Rock"],
		baseStats: { hp: 110, atk: 155, def: 115, spa: 50, spd: 90, spe: 85 },
		abilities: { 0: "Moss Armor" },
		heightm: 2.1,
		weightkg: 350.2,
		color: "Green",
		eggGroups: ["Fairy", "Mineral"],
		requiredItem: "Glalitite",
		battleOnly: "Glalie-Aevian",
		changesFrom: "Glalie-Aevian",
		isNonstandard: "Custom",
	},
	spheal: {
		num: 363,
	...
	walrein: {
		...
		name: "Walrein",
		types: ["Ice", "Water"],
		baseStats: { hp: 140, atk: 115, def: 80, spa: 115, spd: 80, spe: 30 },
		abilities: { 0: "Refrigerate", 1: "Ice Body", H: "Accumulation" },
		heightm: 1.4,
		weightkg: 150.6,
		color: "Blue",
		prevo: "Sealeo",
	...
	gorebyss: {
		...
		name: "Gorebyss",
		types: ["Water", "Psychic"],
		baseStats: { hp: 70, atk: 84, def: 115, spa: 124, spd: 85, spe: 52 },
	...
	relicanth: {
		...
		types: ["Water", "Rock"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 100, atk: 105, def: 140, spa: 45, spd: 75, spe: 65 },
		abilities: { 0: "Brute Force", 1: "Relic Armor", H: "Water Veil" },
		heightm: 1,
		weightkg: 23.4,
		color: "Gray",
		eggGroups: ["Water 1", "Water 2"],
	...
	luvdisc: {
		...
		abilities: { 0: "Swift Swim", 1: "Triage", H: "Hydration" },
		heightm: 0.6,
		weightkg: 8.7,
		color: "Pink",
		eggGroups: ["Water 2"],
	...
	salamence: {
		...
		abilities: { 0: "Intimidate", 1: "Wind Rider", H: "Soaring Spirit" },
		heightm: 1.5,
		weightkg: 102.6,
		color: "Blue",
		prevo: "Shelgon",
	...
	metagross: {
		...
		abilities: { 0: "Clear Body", 1: "Defragment", H: "Light Metal" },
		heightm: 1.6,
		weightkg: 550,
		color: "Blue",
		prevo: "Metang",
	...
	registeel: {
		...
		abilities: { 0: "Clear Body", 1: "Light Metal", H: "Bulletproof" },
		heightm: 1.9,
		weightkg: 205,
		color: "Gray",
		tags: ["Sub-Legendary"],
	...
	bibarel: {
		...
		abilities: { 0: "Simple", 1: "Unaware", H: "Thick Fat" },
		heightm: 1,
		weightkg: 31.5,
		color: "Brown",
		prevo: "Bidoof",
	...
	luxraymega: {"num":405,"name":"Luxray-Mega","baseSpecies":"Luxray","forme":"Mega","types":["Electric","Dark"],"baseStats":{"hp":85,"atk":160,"def":91,"spa":90,"spd":104,"spe":105},"abilities":{"0":"Night Hunt"},"heightm":1.4,"weightkg":42,"color":"Blue","eggGroups":["Field"],"requiredItem":"Luxranite","battleOnly":"Luxray","isNonstandard":"Custom"},
	luxray: {
		otherFormes: ["Luxray-Mega"],
		num: 405,
		name: "Luxray",
		types: ["Electric", "Dark"],
		baseStats: { hp: 85, atk: 125, def: 85, spa: 65, spd: 85, spe: 95 },
		abilities: { 0: "Strong Jaw", 1: "Galvanize", H: "Intimidate" },
		heightm: 1.4,
		weightkg: 42,
		color: "Blue",
		prevo: "Luxio",
	...
	roserade: {
		...
		evoItem: "Shiny Stone",
		eggGroups: ["Fairy", "Grass"],
		otherFormes: ["Roserade-Mega", "Roserade-Aevian"],
		formeOrder: ["Roserade", "Roserade-Mega", "Roserade-Aevian"],
	},
	roseradeaevian: {
		num: 407,
		name: "Roserade-Aevian",
		baseSpecies: "Roserade-Aevian",
		forme: "Aevian",
		types: ["Ground", "Fighting"],
		baseStats: { hp: 75, atk: 60, def: 75, spa: 125, spd: 115, spe: 90 },
		abilities: { 0: "Dry Skin", 1: "Technician", H: "False Devotion" },
		heightm: 0.9,
		weightkg: 14.5,
		color: "Brown",
		eggGroups: ["Fairy", "Grass"],
	...
	rampardos: {
		...
		types: ["Rock", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 87, atk: 165, def: 80, spa: 30, spd: 75, spe: 93 },
		abilities: { 0: "Intrepid Sword", 1: "Relic Armor", H: "Steelworker" },
		heightm: 1.6,
		weightkg: 102.5,
		color: "Blue",
		prevo: "Cranidos",
	...
	bastiodon: {
		...
		types: ["Rock", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 90, atk: 40, def: 180, spa: 25, spd: 165, spe: 30 },
		abilities: { 0: "Dauntless Shield", 1: "Relic Armor", H: "Soundproof" },
		heightm: 1.3,
		weightkg: 149.5,
		color: "Gray",
		prevo: "Shieldon",
	...
	mothim: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: { hp: 80, atk: 60, def: 60, spa: 134, spd: 60, spe: 126 },
		abilities: { 0: "Swarm", 1: "Protean", H: "Tinted Lens" },
		heightm: 0.9,
		weightkg: 23.3,
		color: "Yellow",
		prevo: "Burmy",
	...
	vespiquen: {
		...
		types: ["Bug", "Flying"],
		gender: "F",
		baseStats: { hp: 100, atk: 100, def: 122, spa: 40, spd: 122, spe: 30 },
		abilities: { 0: "Pressure", 1: "Queenly Majesty", H: "Royal Hive" },
		heightm: 1.2,
		weightkg: 38.5,
		color: "Yellow",
		prevo: "Combee",
	...
	floatzel: {
		...
		name: "Floatzel",
		types: ["Water", "Fighting"],
		baseStats: { hp: 90, atk: 125, def: 65, spa: 55, spd: 70, spe: 115 },
		abilities: { 0: "Swift Swim", 1: "Propeller Tail", H: "Battle Fervor" },
		heightm: 1.1,
		weightkg: 33.5,
		color: "Brown",
		prevo: "Buizel",
	...
	cherrim: {
		...
		abilities: { 0: "Flower Gift", 1: "Solar Bloom", H: "Mega Sol" },
		heightm: 0.5,
		weightkg: 9.3,
		color: "Purple",
		prevo: "Cherubi",
	...
	cherrimsunshine: {
		...
		forme: "Sunshine",
		types: ["Grass", "Fairy"],
		baseStats: { hp: 70, atk: 95, def: 80, spa: 110, spd: 110, spe: 105 },
		abilities: { 0: "Flower Gift", 1: "Solar Bloom", H: "Mega Sol" },
		heightm: 0.5,
		weightkg: 9.3,
		color: "Pink",
		eggGroups: ["Fairy", "Grass"],
		requiredAbility: "Solar Bloom",
		battleOnly: "Cherrim",
	},
	shellos: {
		num: 422,
	...
	gastrodon: {
		...
		evoLevel: 30,
		eggGroups: ["Water 1", "Amorphous"],
		cosmeticFormes: ["Gastrodon-East", "Gastrodon-Azzy", "Gastrodon-Azzy2"],
		formeOrder: ["Gastrodon", "Gastrodon-East", "Gastrodon-Azzy", "Gastrodon-Azzy2"],
	},
	gastrodoneast: {
		isCosmeticForme: true,
		name: "Gastrodon-East",
	...
	gastrodonaevian: {
		...
		baseSpecies: "Gastrodon-Aevian",
		forme: "Aevian",
		types: ["Ground", "Fairy"],
		baseStats: { hp: 118, atk: 83, def: 77, spa: 92, spd: 91, spe: 39 },
	...
	gastrodoneastaevian: {
		...
		baseSpecies: "Gastrodon-East-Aevian",
		forme: "East-Aevian",
		types: ["Ground", "Fairy"],
		baseStats: { hp: 118, atk: 83, def: 77, spa: 92, spd: 91, spe: 39 },
	...
	ambipom: {
		...
		abilities: { 0: "Whiplash", 1: "Double Strike", H: "Scrappy" },
		heightm: 1.2,
		weightkg: 20.3,
		color: "Purple",
		prevo: "Aipom",
	...
	drifblim: {
		...
		abilities: { 0: "Windy Surge", 1: "Unburden", H: "Flare Boost" },
		heightm: 1.2,
		weightkg: 15,
		color: "Purple",
		prevo: "Drifloon",
	...
	bronzong: {
		...
		types: ["Steel", "Psychic"],
		gender: "N",
		baseStats: { hp: 67, atk: 89, def: 116, spa: 89, spd: 116, spe: 33 },
	...
	bronzongmega: {"num":437,"name":"Bronzong-Mega","baseSpecies":"Bronzong","forme":"Mega","types":["Steel","Psychic"],"gender":"N","baseStats":{"hp":67,"atk":104,"def":156,"spa":104,"spd":156,"spe":23},"abilities":{"0":"Storm Bell"},"heightm":1.3,"weightkg":187,"color":"Blue","eggGroups":["Mineral"],"requiredItem":"Bronzongite","battleOnly":"Bronzong","isNonstandard":"Custom"},
	bronzongrejuv: {
		num: 437,
		name: "Bronzong-Rejuv",
	...
	chatot: {
		...
		name: "Chatot",
		types: ["Normal", "Flying"],
		baseStats: { hp: 96, atk: 72, def: 65, spa: 112, spd: 65, spe: 121 },
		abilities: { 0: "Echo Fiend", 1: "Cloud Nine", H: "Opportunist" },
		heightm: 0.5,
		weightkg: 1.9,
		color: "Black",
		eggGroups: ["Flying"],
	...
	baseStats: { hp: 108, atk: 108, def: 108, spa: 108, spd: 108, spe: 30 },
		abilities: { 0: "Intimidate", 1: "Mourning Vessel", H: "Pressure" },
		heightm: 1,
		weightkg: 108,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	garchomp: {
		...
		abilities: { 0: "Rough Skin", 1: "Supreme Overlord", H: "Battle Bond" },
		heightm: 1.9,
		weightkg: 95,
		color: "Blue",
		prevo: "Gabite",
		evoLevel: 48,
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["Garchomp-Mega", "Garchomp-Mega-Z", "Garchomp-Battle-Bond"],
		formeOrder: ["Garchomp", "Garchomp-Mega", "Garchomp-Mega-Z", "Garchomp-Battle-Bond"],
	},
	garchompmega: {
		num: 445,
		name: "Garchomp-Mega",
		...
		forme: "Mega",
		types: ["Dragon", "Ground"],
		baseStats: { hp: 108, atk: 170, def: 125, spa: 70, spd: 125, spe: 102 },
		abilities: { 0: "Apex Cleave" },
		heightm: 1.9,
		weightkg: 95,
		color: "Blue",
		eggGroups: ["Monster", "Dragon"],
	...
	garchompbattlebond: {
		...
		forme: "Battle-Bond",
		types: ["Dragon", "Ground"],
		baseStats: { hp: 108, atk: 160, def: 100, spa: 130, spd: 110, spe: 122 },
		abilities: { 0: "Apex Bond" },
		heightm: 1.9,
		weightkg: 95,
		color: "Blue",
		eggGroups: ["Monster", "Dragon"],
	...
	lucariomega: {
		...
		types: ["Fighting", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 150, def: 98, spa: 145, spd: 75, spe: 122 },
		abilities: { 0: "Aura Instinct" },
		heightm: 1.3,
		weightkg: 57.5,
		color: "Blue",
		eggGroups: ["Field", "Human-Like"],
	...
	hippopotas: {
		...
		abilities: { 0: "Sand Stream", 1: "Accumulation", H: "Earth Eater" },
		heightm: 0.8,
		weightkg: 49.5,
		color: "Brown",
		evos: ["Hippowdon"],
	...
	drapion: {
		...
		evoLevel: 40,
		eggGroups: ["Bug", "Water 3"],
		otherFormes: ["Drapion-Rejuv"],
		formeOrder: ["Drapion", "Drapion-Rejuv"],
	},
	drapionrejuv: {
		num: 452,
		name: "Drapion-Rejuv",
		...
		forme: "Rejuv",
		types: ["Poison", "Ice"],
		baseStats: { hp: 80, atk: 125, def: 110, spa: 60, spd: 80, spe: 95 },
		abilities: { 0: "Aevian Toxin" },
		heightm: 1.3,
		weightkg: 61.5,
		color: "Purple",
		eggGroups: ["Bug", "Water 3"],
		requiredAbility: "Aevian Toxin",
		battleOnly: "Drapion",
		isNonstandard: "Custom",
	},
	croagunk: {
	...
	magnezone: {
		...
		types: ["Electric", "Steel"],
		gender: "N",
		baseStats: { hp: 90, atk: 70, def: 120, spa: 135, spd: 95, spe: 60 },
		abilities: { 0: "Magnet Pull", 1: "Defragment", H: "Elevate" },
		heightm: 1.2,
		weightkg: 180,
		color: "Gray",
		prevo: "Magneton",
	...
	lickilicky: {
		...
		name: "Lickilicky",
		types: ["Normal"],
		baseStats: { hp: 125, atk: 110, def: 95, spa: 80, spd: 100, spe: 40 },
		abilities: { 0: "Own Tempo", 1: "Accumulation", H: "Gluttony" },
		heightm: 1.7,
		weightkg: 140,
		color: "Pink",
		prevo: "Lickitung",
	...
	rhyperior: {
		...
		name: "Rhyperior",
		types: ["Ground", "Steel"],
		baseStats: { hp: 120, atk: 150, def: 140, spa: 55, spd: 85, spe: 20 },
	...
	electivire: {
		...
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 85, atk: 123, def: 82, spa: 95, spd: 90, spe: 95 },
	...
	magmortar: {
		...
		types: ["Fire","Steel"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 85, atk: 95, def: 82, spa: 125, spd: 100, spe: 83 },
		abilities: { 0: "Magma Armor", 1: "Mega Launcher", H: "Vital Spirit" },
		heightm: 1.6,
		weightkg: 68,
		color: "Red",
		prevo: "Magmar",
	...
	leafeon: {
		...
		abilities: { 0: "Verdant Edge", 1: "Regenerator", H: "Grassy Surge" },
		heightm: 1,
		weightkg: 25.5,
		color: "Green",
		prevo: "Eevee",
	...
	glaceon: {
		...
		abilities: { 0: "Permafrost", 1: "Slush Rush", H: "Snow Warning", S: "Mind Freeze" },
		heightm: 0.8,
		weightkg: 25.9,
		color: "Blue",
		prevo: "Eevee",
	...
	gliscor: {
		...
		evoCondition: "at night",
		eggGroups: ["Bug"],
		otherFormes: ["Gliscor-Alt"],
		cosmeticFormes: ["Gliscor-Alt"],
		formeOrder: ["Gliscor", "Gliscor-Alt"],
	},
	mamoswine: {
		num: 473,
		name: "Mamoswine",
	...
	porygonz: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: { hp: 85, atk: 80, def: 80, spa: 150, spd: 85, spe: 90 },
		abilities: { 0: "Defragment", 1: "Download", H: "Memory Leak" },
		heightm: 0.9,
		weightkg: 34,
		color: "Red",
		prevo: "Porygon2",
	...
	probopass: {
		...
		name: "Probopass",
		types: ["Rock", "Steel"],
		baseStats: { hp: 75, atk: 65, def: 150, spa: 95, spd: 155, spe: 30 },
		abilities: { 0: "Magnet Pull", 1: "Nose Formation", H: "Heavy Metal" },
		heightm: 1.4,
		weightkg: 340,
		color: "Gray",
		prevo: "Nosepass",
	...
	dusknoirmega: {"num":477,"name":"Dusknoir-Mega","baseSpecies":"Dusknoir","forme":"Mega","types":["Ghost","Dark"],"baseStats":{"hp":65,"atk":180,"def":155,"spa":70,"spd":155,"spe":45},"abilities":{"0":"Reaper's Grip"},"heightm":2.2,"weightkg":106.6,"color":"Black","eggGroups":["Amorphous"],"requiredItem":"Dusknoirite","battleOnly":"Dusknoir","isNonstandard":"Custom"},
	dusknoir: {
		otherFormes: ["Dusknoir-Mega"], formeOrder: ["Dusknoir", "Dusknoir-Mega"],
		num: 477,
		name: "Dusknoir",
		types: ["Ghost", "Dark"],
		baseStats: {"hp":65,"atk":120,"def":135,"spa":70,"spd":135,"spe":45},
		abilities: {0: 'Requiem', 1: 'Pressure', H: 'Shadow Tag'},
		heightm: 2.2,
		weightkg: 106.6,
		color: "Black",
		prevo: "Dusclops",
	...
	froslass: {
		...
		evoItem: "Dawn Stone",
		eggGroups: ["Fairy", "Mineral"],
		otherFormes: ["Froslass-Mega", "Froslass-Aevian", "Froslass-Aevian-Mega"],
		formeOrder: ["Froslass", "Froslass-Mega", "Froslass-Aevian", "Froslass-Aevian-Mega"],
	},
	froslassmega: {
		num: 478,
		name: "Froslass-Mega",
		...
		types: ["Ice", "Ghost"],
		gender: "F",
		baseStats: { hp: 70, atk: 80, def: 70, spa: 140, spd: 100, spe: 140 },
	...
	rotomheat: {
		...
		gender: "N",
		baseStats: { hp: 60, atk: 65, def: 107, spa: 105, spd: 107, spe: 86 },
		abilities: { 0: "Levitate", 1: "Drought", H: "Flame Body" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
		eggGroups: ["Amorphous"],
	...
	rotomwash: {
		...
		gender: "N",
		baseStats: { hp: 60, atk: 65, def: 107, spa: 105, spd: 107, spe: 86 },
		abilities: { 0: "Levitate", 1: "Storm Drain", H: "Drizzle" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
		eggGroups: ["Amorphous"],
	...
	rotomfrost: {
		...
		gender: "N",
		baseStats: { hp: 60, atk: 65, def: 107, spa: 105, spd: 107, spe: 86 },
		abilities: { 0: "Levitate", 1: "Refrigerate", H: "Snow Warning" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
		eggGroups: ["Amorphous"],
	...
	rotommow: {
		...
		gender: "N",
		baseStats: { hp: 60, atk: 65, def: 107, spa: 105, spd: 107, spe: 86 },
		abilities: { 0: "Levitate", 1: "Grassy Surge", H: "Seed Sower" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
		eggGroups: ["Amorphous"],
	...
	shaymin: {
		...
		gender: "N",
		baseStats: { hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100 },
		abilities: { 0: "Natural Cure", 1: "Hospitality" },
		heightm: 0.2,
		weightkg: 2.1,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	froslassaevian: {
		...
		baseSpecies: "Froslass-Aevian",
		forme: "Aevian",
		types: ["Grass", "Water"],
		gender: "F",
		baseStats: { hp: 70, atk: 70, def: 70, spa: 110, spd: 70, spe: 110 },
		abilities: { 0: "Adaptability", 1: "Gooey", H: "Storm Power" },
		heightm: 1.3,
		weightkg: 26.6,
		color: "Green",
		eggGroups: ["Fairy", "Mineral"],
		otherFormes: ["Froslass-Aevian-Mega"],
		formeOrder: ["Froslass-Aevian", "Froslass-Aevian-Mega"],
		isNonstandard: "Custom",
	},
	froslassaevianmega: {
		num: 478,
		name: "Froslass-Aevian-Mega",
		baseSpecies: "Froslass-Aevian",
		forme: "Mega-Aevian",
		types: ["Grass", "Water"],
		gender: "F",
		baseStats: { hp: 70, atk: 80, def: 70, spa: 140, spd: 100, spe: 140 },
		abilities: { 0: "Storm Calling" },
		heightm: 2.6,
		weightkg: 29.6,
		color: "Green",
		eggGroups: ["Fairy", "Mineral"],
		requiredItem: "Froslassite",
		battleOnly: "Froslass-Aevian",
		changesFrom: "Froslass-Aevian",
		isMega: true,
		isNonstandard: "Custom",
	},
	chimechomegay: {
	...
	samurott: {
		...
		types: ["Water", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 90, atk: 105, def: 85, spa: 115, spd: 80, spe: 75 },
		...
		cosmeticFormes: ["Samurott-Alt"],
		formeOrder: ["Samurott", "Samurott-Hisui", "Samurott-Alt"],
	},
	samurottalt: {
		isCosmeticForme: true,
		num: 503,
	...
	samurotthisui: {
		...
		types: ["Water", "Dark"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 90, atk: 115, def: 80, spa: 105, spd: 65, spe: 95 },
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		cosmeticFormes: ["Samurott-Hisui-Alt"],
		formeOrder: ["Samurott-Hisui", "Samurott-Hisui-Alt"],
	},
	samurotthisuialt: {
		isCosmeticForme: true,
		num: 503,
	...
	herdier: {
		...
		abilities: { 0: "Intimidate", 1: "Sand Rush", H: "Guard Dog" },
		heightm: 0.9,
		weightkg: 14.7,
		color: "Gray",
		prevo: "Lillipup",
	...
	stoutland: {
		...
		name: "Stoutland",
		types: ["Normal", "Ground"],
		baseStats: { hp: 90, atk: 130, def: 95, spa: 40, spd: 90, spe: 80 },
	...
	liepard: {
		...
		name: "Liepard",
		types: ["Dark"],
		baseStats: { hp: 75, atk: 110, def: 60, spa: 110, spd: 60, spe: 110 },
		abilities: { 0: "Limber", 1: "Strong Jaw", H: "Prankster" },
		heightm: 1.1,
		weightkg: 37.5,
		color: "Purple",
		prevo: "Purrloin",
	...
	simisage: {
		...
		abilities: { 0: "Primal Tactics", 1: "Grassy Surge", H: "Scrappy" },
		heightm: 1.1,
		weightkg: 30.5,
		color: "Green",
		prevo: "Pansage",
	...
	simisear: {
		...
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 98, def: 63, spa: 98, spd: 63, spe: 101 },
		abilities: { 0: "Primal Tactics", 1: "Drought", H: "Scrappy" },
		heightm: 1,
		weightkg: 28,
		color: "Red",
		prevo: "Pansear",
	...
	simipour: {
		...
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 98, def: 63, spa: 98, spd: 63, spe: 101 },
		abilities: { 0: "Primal Tactics", 1: "Drizzle", H: "Scrappy" },
		heightm: 1,
		weightkg: 29,
		color: "Blue",
		prevo: "Panpour",
	...
	musharna: {
		...
		baseStats: { hp: 120, atk: 45, def: 95, spa: 110, spd: 105, spe: 25 },
	...
	zebstrika: {
		...
		name: "Zebstrika",
		types: ["Electric", "Fire"],
		baseStats: { hp: 85, atk: 100, def: 75, spa: 80, spd: 74, spe: 116 },
		abilities: { 0: "Solar Power", 1: "Lightning Rod", H: "Speed Boost" },
		heightm: 1.6,
		weightkg: 79.5,
		color: "Black",
		prevo: "Blitzle",
	...
	gigalith: {
		...
		name: "Gigalith",
		types: ["Rock"],
		baseStats: { hp: 100, atk: 135, def: 130, spa: 60, spd: 100, spe: 25 },
	...
	swoobat: {
		...
		name: "Swoobat",
		types: ["Psychic", "Flying"],
		baseStats: { hp: 92, atk: 57, def: 80, spa: 77, spd: 80, spe: 114 },
		abilities: { 0: "Unaware", 1: "Klutz", H: "Simple" },
		heightm: 0.9,
		weightkg: 10.5,
		color: "Blue",
	...
	audinomega: {
		...
		forme: "Mega",
		types: ["Normal", "Fairy"],
		baseStats: { hp: 103, atk: 60, def: 136, spa: 100, spd: 136, spe: 50 },
		abilities: { 0: "Divine Intervention" },
		heightm: 1.5,
		weightkg: 32,
		color: "White",
		eggGroups: ["Fairy"],
	...
	throh: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: { hp: 125, atk: 100, def: 100, spa: 30, spd: 100, spe: 45 },
		abilities: { 0: "Ultra Ego", 1: "Inner Focus", H: "Mold Breaker" },
		heightm: 1.3,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
	...
	sawk: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: { hp: 90, atk: 125, def: 85, spa: 30, spd: 85, spe: 85 },
		abilities: { 0: "Ultra Instinct", 1: "Inner Focus", H: "Mold Breaker" },
		heightm: 1.4,
		weightkg: 51,
		color: "Blue",
		eggGroups: ["Human-Like"],
	...
	swadloon: {
		...
		abilities: { 0: "Invigorate", 1: "Chlorophyll", H: "Overcoat" },
		heightm: 0.5,
		weightkg: 7.3,
		color: "Green",
		prevo: "Sewaddle",
	...
	leavanny: {
		...
		abilities: { 0: "Triage", 1: "Chlorophyll", H: "Sharpness" },
		heightm: 1.2,
		weightkg: 20.5,
		color: "Yellow",
		prevo: "Swadloon",
	...
	cottonee: {
		...
		abilities: { 0: "Prankster", 1: "Cotton Down", H: "Chlorophyll" },
		heightm: 0.3,
		weightkg: 0.6,
		color: "Green",
		evos: ["Whimsicott"],
	...
	whimsicott: {
		...
		name: "Whimsicott",
		types: ["Grass", "Fairy"],
		baseStats: { hp: 60, atk: 67, def: 85, spa: 117, spd: 75, spe: 116 },
		abilities: { 0: "Prankster", 1: "Wind Power", H: "Chlorophyll" },
		heightm: 0.7,
		weightkg: 6.6,
		color: "Green",
		prevo: "Cottonee",
	...
	petilil: {
		...
		abilities: { 0: "Chlorophyll", 1: "Own Tempo", H: "Invigorate" },
		heightm: 0.5,
		weightkg: 6.6,
		color: "Green",
	...
	lilligant: {
		...
		types: ["Grass", "Fairy"],
		gender: "F",
		baseStats: { hp: 80, atk: 50, def: 85, spa: 125, spd: 85, spe: 95 },
		...
		evoItem: "Sun Stone",
		eggGroups: ["Grass"],
		otherFormes: ["Lilligant-Hisui", "Lilligant-Rift", "Lilligant-Hisui-Rift"],
		formeOrder: ["Lilligant", "Lilligant-Hisui", "Lilligant-Rift", "Lilligant-Hisui-Rift"],
	},
	lilligantrift: {
		num: 549,
		name: "Lilligant-Rift",
	...
	lilliganthisui: {
		...
		evoItem: "Sun Stone",
		eggGroups: ["Grass"],
		otherFormes: ["Lilligant-Hisui-Rift"],
		formeOrder: ["Lilligant-Hisui", "Lilligant-Hisui-Rift"],
	},
	lilliganthisuirift: {
		num: 549,
	...
	krookodile: {
		...
		name: "Krookodile",
		types: ["Ground", "Dark"],
		baseStats: { hp: 100, atk: 125, def: 85, spa: 60, spd: 78, spe: 92 },
		abilities: { 0: "Intimidate", 1: "Moxie", H: "Vendetta" },
		heightm: 1.5,
		weightkg: 96.3,
		color: "Red",
		prevo: "Krokorok",
	...
	darmanitan: {
		...
		baseForme: "Standard",
		types: ["Fire"],
		baseStats: { hp: 105, atk: 140, def: 65, spa: 30, spd: 65, spe: 95 },
	...
	darmanitanzen: {
		...
		forme: "Zen",
		types: ["Fire", "Psychic"],
		baseStats: { hp: 105, atk: 30, def: 115, spa: 140, spd: 115, spe: 55 },
	...
	darmanitangalarzen: {
		...
		forme: "Galar-Zen",
		types: ["Ice", "Fire"],
		baseStats: { hp: 105, atk: 160, def: 65, spa: 30, spd: 65, spe: 135 },
		abilities: { 0: "Zen Mode" },
		heightm: 1.7,
		weightkg: 120,
		color: "White",
	...
	dwebble: {
		...
		abilities: { 0: "Sturdy", 1: "Shell Armor", H: "Shed Skin" },
		heightm: 0.3,
		weightkg: 14.5,
		color: "Red",
		evos: ["Crustle"],
	...
	sigilyph: {
		...
		abilities: { 0: "Tablets of Ruin", 1: "Magic Guard", H: "Tinted Lens", S: "Aevian Grief" },
		heightm: 1.4,
		weightkg: 14,
		color: "Black",
		eggGroups: ["Flying"],
		otherFormes: ["Sigilyph-Rejuv"],
		formeOrder: ["Sigilyph", "Sigilyph-Rejuv"],
	},
	sigilyphrejuv: {
		num: 561,
		name: "Sigilyph-Rejuv",
		...
		types: ["Ghost", "Fairy"],
		baseStats: { hp: 72, atk: 58, def: 80, spa: 103, spd: 80, spe: 97 },
		abilities: { 0: "Aevian Grief" },
		heightm: 1.4,
		weightkg: 14,
		color: "Black",
		eggGroups: ["Flying"],
		requiredAbility: "Aevian Grief",
		battleOnly: "Sigilyph",
		isNonstandard: "Custom",
	},
	yamask: {
	...
	cofagrigus: {
		...
		name: "Cofagrigus",
		types: ["Ghost", "Steel"],
		baseStats: { hp: 75, atk: 50, def: 145, spa: 115, spd: 105, spe: 30 },
		abilities: { 0: "Mummy", 1: "Neutralization", H: "Shadow Shield" },
		heightm: 1.7,
		weightkg: 76.5,
		color: "Yellow",
		prevo: "Yamask",
	...
	archeops: {
		...
		types: ["Rock", "Flying"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 90, atk: 155, def: 85, spa: 115, spd: 85, spe: 110 },
	...
	garbodor: {
		...
		name: "Garbodor",
		types: ["Poison", "Steel"],
		baseStats: { hp: 80, atk: 125, def: 100, spa: 70, spd: 100, spe: 75 },
		abilities: { 0: "Toxic Debris", 1: "Byxbysion Touch", H: "Regenerator" },
		heightm: 1.9,
		weightkg: 107.3,
		color: "Green",
		prevo: "Trubbish",
	...
	garbodorgmax: {
		...
		forme: "Gmax",
		types: ["Poison", "Steel"],
		baseStats: { hp: 120, atk: 125, def: 100, spa: 70, spd: 100, spe: 75 },
		abilities: { 0: "Wasting Surge" },
		heightm: 21,
		weightkg: 0,
		color: "Green",
		eggGroups: ["Mineral"],
	...
	zorua: {
		...
		abilities: { 0: "Illusion", 1: "Opportunist" },
		heightm: 0.7,
		weightkg: 12.5,
		color: "Gray",
		evos: ["Zoroark"],
	...
	zoroarkhisui: {
		...
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 55, atk: 100, def: 60, spa: 125, spd: 60, spe: 110 },
		abilities: { 0: "Illusion", 1: "Opportunist", H: "Shadow Tag" },
		heightm: 1.6,
		weightkg: 73,
		color: "Gray",
		prevo: "Zorua-Hisui",
	...
	cinccino: {
		...
		abilities: { 0: "Whiplash", 1: "Skill Link", H: "Fluffy Craft" },
		heightm: 0.5,
		weightkg: 7.5,
		color: "Gray",
		prevo: "Minccino",
	...
	gothitelle: {
		...
		types: ["Psychic"],
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 80, atk: 55, def: 110, spa: 95, spd: 125, spe: 65 },
		abilities: { 0: "Shadow Tag", 1: "Temporal Shift", H: "Eclipse Vision" },
		heightm: 1.5,
		weightkg: 44,
		color: "Purple",
		prevo: "Gothorita",
	...
	solosis: {
		...
		abilities: { 0: "Adaptive Cell", 1: "Magic Guard", H: "Regenerator" },
		heightm: 0.3,
		weightkg: 1,
		color: "Green",
		evos: ["Duosion"],
	...
	reuniclus: {
		...
		name: "Reuniclus",
		types: ["Psychic"],
		baseStats: { hp: 110, atk: 65, def: 95, spa: 125, spd: 105, spe: 30 },
		abilities: { 0: "Adaptive Cell", 1: "Magic Guard", H: "Regenerator" },
		heightm: 1,
		weightkg: 20.1,
		color: "Green",
	...
	reuniclusmega: {
		...
		forme: "Mega",
		types: ["Psychic", "Fighting"],
		baseStats: { hp: 110, atk: 85, def: 115, spa: 155, spd: 115, spe: 50 },
		abilities: { 0: "Adaptive Power" },
		heightm: 1,
		weightkg: 20.1,
		color: "Green",
		eggGroups: ["Amorphous"],
	...
	swanna: {
		...
		abilities: { 0: "Wind Rider", 1: "Swift Swim", H: "Gale Wings" },
		heightm: 1.3,
		weightkg: 24.2,
		color: "White",
		prevo: "Ducklett",
	...
	vanilluxe: {
		...
		abilities: { 0: "Ice Body", 1: "Snow Warning", H: "Slush Rush" },
		heightm: 1.3,
		weightkg: 57.5,
		color: "White",
		prevo: "Vanillish",
	...
	sawsbuck: {
		...
		name: "Sawsbuck",
		types: ["Water", "Grass"],
		baseStats: { hp: 80, atk: 110, def: 80, spa: 60, spd: 80, spe: 100 },
		abilities: { 0: "Seasonal Stride", 1: "Swift Swim", H: "Sap Sipper" },
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
		prevo: "Deerling",
	...
	sawsbucksummer: {
		...
		types: ["Fire", "Grass"],
		baseStats: { hp: 80, atk: 110, def: 80, spa: 60, spd: 80, spe: 100 },
		abilities: { 0: "Seasonal Stride", 1: "Flash Fire", H: "Rock Head" },
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
		prevo: "Deerling",
	...
	sawsbuckautumn: {
		...
		types: ["Ground", "Grass"],
		baseStats: { hp: 80, atk: 110, def: 80, spa: 60, spd: 80, spe: 100 },
		abilities: { 0: "Seasonal Stride", 1: "Sand Rush", H: "Stamina" },
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
		prevo: "Deerling",
	...
	sawsbuckwinter: {
		...
		types: ["Ice", "Grass"],
		baseStats: { hp: 80, atk: 110, def: 80, spa: 60, spd: 80, spe: 100 },
		abilities: { 0: "Seasonal Stride", 1: "Ice Body", H: "Slush Rush" },
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
		prevo: "Deerling",
	...
	jellicent: {
		...
		name: "Jellicent",
		types: ["Water", "Ghost"],
		baseStats: { hp: 100, atk: 60, def: 80, spa: 85, spd: 115, spe: 60 },
		abilities: { 0: "Water Absorb", 1: "Cursed Body", H: "Damp" },
	...
	alomomola: {
		...
		abilities: { 0: "Invigorate", 1: "Hydration", H: "Regenerator" },
		heightm: 1.2,
		weightkg: 31.6,
		color: "Pink",
		eggGroups: ["Water 1", "Water 2"],
	...
	galvantula: {
		...
		abilities: { 0: "Compound Eyes", 1: "Unnerve", H: "Neutralization" },
		heightm: 0.8,
		weightkg: 14.3,
		color: "Yellow",
		prevo: "Joltik",
	...
	eelektross: {
		...
		abilities: { 0: "Elevate", 1: "Swift Swim", H: "Regenerator" },
		heightm: 2.1,
		weightkg: 80.5,
		color: "Blue",
		prevo: "Eelektrik",
	...
	eelektrossmega: {
		...
		forme: "Mega",
		types: ["Electric"],
		baseStats: { hp: 85, atk: 145, def: 90, spa: 135, spd: 100, spe: 80 },
		abilities: { 0: "Storm Circuit" },
		heightm: 3,
		weightkg: 160,
		color: "Blue",
		eggGroups: ["Amorphous"],
	...
	beheeyem: {
		...
		baseStats: { hp: 85, atk: 55, def: 85, spa: 125, spd: 110, spe: 30 },
		abilities: { 0: "Telepathy", 1: "Neutralization", H: "Memory Leak" },
		heightm: 1,
		weightkg: 34.5,
		color: "Brown",
		prevo: "Elgyem",
	...
	chandelure: {
		...
		abilities: { 0: "Flash Fire", 1: "Temporal Shift", H: "Soul Fire" },
		heightm: 1,
		weightkg: 34.3,
		color: "Black",
		prevo: "Lampent",
	...
	chandelureaevian: {
		...
		baseSpecies: "Chandelure-Aevian",
		forme: "Aevian",
		types: ["Ghost", "Electric"],
		baseStats: { hp: 85, atk: 50, def: 90, spa: 145, spd: 90, spe: 80 },
		abilities: { 0: "Illuminate", 1: "Levitate", H: "Magic Guard" },
		heightm: 1,
		weightkg: 34.3,
		color: "Black",
		eggGroups: ["Amorphous"],
	...
	beartic: {
		...
		name: "Beartic",
		types: ["Ice", "Dark"],
		baseStats: { hp: 110, atk: 130, def: 90, spa: 55, spd: 85, spe: 75 },
		abilities: { 0: "Raging Beast", 1: "Slush Rush", H: "Swift Swim" },
		heightm: 2.6,
		weightkg: 260,
		color: "White",
		prevo: "Cubchoo",
	...
	accelgor: {
		...
		name: "Accelgor",
		types: ["Bug", "Ghost"],
		baseStats: { hp: 90, atk: 70, def: 50, spa: 100, spd: 65, spe: 145 },
		abilities: { 0: "Scrappy", 1: "Sticky Hold", H: "Unburden" },
		heightm: 0.8,
		weightkg: 25.3,
		color: "Red",
		prevo: "Shelmet",
	...
	mienshao: {
		...
		abilities: { 0: "Inner Focus", 1: "Regenerator", H: "Sworn Duty" },
		heightm: 1.4,
		weightkg: 35.5,
		color: "Purple",
		prevo: "Mienfoo",
	...
	druddigon: {
		...
		abilities: { 0: "Solar Recharge", 1: "Cavern Drake", H: "Rough Scale", S: "Aevian Bolt" },
		heightm: 1.6,
		weightkg: 139,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["Druddigon-Rejuv"],
		formeOrder: ["Druddigon", "Druddigon-Rejuv"],
	},
	druddigonrejuv: {
		num: 621,
		name: "Druddigon-Rejuv",
		baseSpecies: "Druddigon",
		forme: "Rejuv",
		types: ["Dragon", "Electric"],
		baseStats: { hp: 107, atk: 60, def: 88, spa: 120, spd: 100, spe: 80 },
		abilities: { 0: "Aevian Bolt" },
		heightm: 1.6,
		weightkg: 139,
		color: "Black",
		eggGroups: ["Monster", "Dragon"],
		requiredAbility: "Aevian Bolt",
		battleOnly: "Druddigon",
		isNonstandard: "Custom",
	},
	golett: {
		num: 622,
	...
	golurk: {
		...
		types: ["Ground", "Ghost"],
		gender: "N",
		baseStats: { hp: 100, atk: 125, def: 110, spa: 45, spd: 105, spe: 55 },
		abilities: { 0: "Iron Fist", 1: "No Guard", H: "Self Repair" },
		heightm: 2.8,
		weightkg: 330,
		color: "Green",
		prevo: "Golett",
	...
	golurkmega: {
		...
		types: ["Ground", "Ghost"],
		gender: "N",
		baseStats: { hp: 100, atk: 170, def: 135, spa: 70, spd: 110, spe: 55 },
		abilities: { 0: "Phantom Fist" },
		heightm: 4,
		weightkg: 330,
		color: "Green",
		eggGroups: ["Mineral"],
	...
	bouffalant: {
		...
		name: "Bouffalant",
		types: ["Normal"],
		baseStats: { hp: 110, atk: 110, def: 110, spa: 40, spd: 115, spe: 55 },
		abilities: { 0: "Violent Rush", 1: "Mold Breaker", H: "Soundproof" },
		heightm: 1.6,
		weightkg: 94.6,
		color: "Brown",
		eggGroups: ["Field"],
	...
	braviary: {
		...
		types: ["Fighting", "Flying"],
		gender: "M",
		baseStats: { hp: 110, atk: 123, def: 85, spa: 57, spd: 85, spe: 80 },
	...
	braviaryhisui: {
		...
		types: ["Psychic", "Flying"],
		gender: "M",
		baseStats: { hp: 120, atk: 57, def: 80, spa: 123, spd: 80, spe: 80 },
	...
	heatmor: {
		...
		abilities: { 0: "Tough Claws", 1: "White Smoke", H: "Mold Breaker" },
		heightm: 1.4,
		weightkg: 58,
		color: "Red",
		eggGroups: ["Field"],
	...
	durant: {
		...
		abilities: { 0: "Armorize", 1: "Hustle", H: "Truant" },
		heightm: 0.3,
		weightkg: 33,
		color: "Gray",
		eggGroups: ["Bug"],
	...
	zweilous: {
		...
		abilities: { 0: "Hustle", 1: "Hydra Bond", H: "Defiant" },
		heightm: 1.4,
		weightkg: 50,
		color: "Blue",
		prevo: "Deino",
	...
	hydreigon: {
		...
		evoLevel: 64,
		eggGroups: ["Dragon"],
		otherFormes: ["Hydreigon-Mega-X"],
		formeOrder: ["Hydreigon", "Hydreigon-Mega-X"],
	},
	hydreigonmegax: {
		num: 635,
		name: "Hydreigon-Mega-X",
		baseSpecies: "Hydreigon",
		forme: "Mega-X",
		types: ["Dark", "Dragon"],
		baseStats: { hp: 92, atk: 155, def: 115, spa: 135, spd: 115, spe: 88 },
		abilities: { 0: "True Hydra" },
		heightm: 1.8,
		weightkg: 160,
		color: "Blue",
		eggGroups: ["Dragon"],
	...
	volcarona: {
		...
		name: "Volcarona",
		types: ["Bug", "Fire"],
		baseStats: { hp: 110, atk: 60, def: 90, spa: 135, spd: 105, spe: 100 },
		abilities: { 0: "Flame Body", 1: "Shield Dust", H: "Drought" },
		heightm: 1.6,
		weightkg: 46,
		color: "White",
		prevo: "Larvesta",
	...
	tornadus: {
		...
		abilities: { 0: "Prankster", 1: "Defiant", H: "Wind Rider" },
		heightm: 1.5,
		weightkg: 63,
		color: "Green",
		tags: ["Sub-Legendary"],
	...
	thundurus: {
		...
		gender: "M",
		baseStats: { hp: 79, atk: 115, def: 70, spa: 125, spd: 80, spe: 111 },
		abilities: { 0: "Prankster", 1: "Wind Power", H: "Competitive" },
		heightm: 1.5,
		weightkg: 61,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	landorus: {
		...
		abilities: { 0: "Sand Force", 1: "Sheer Force", H: "Regenerator" },
		heightm: 1.5,
		weightkg: 68,
		color: "Brown",
		tags: ["Sub-Legendary"],
	...
	delphox: {
		...
		abilities: { 0: "Sworn Duty", 1: "Magic Guard", H: "Magician" },
		heightm: 1.5,
		weightkg: 39,
		color: "Red",
		prevo: "Braixen",
	...
	talonflame: {
		...
		abilities: { 0: "Speed Boost", 1: "Reckless", H: "Gale Wings" },
		heightm: 1.2,
		weightkg: 24.5,
		color: "Red",
		prevo: "Fletchinder",
	...
	pyroarmega: {
		...
		types: ["Fire", "Normal"],
		genderRatio: { M: 0.125, F: 0.875 },
		baseStats: { hp: 86, atk: 88, def: 92, spa: 129, spd: 86, spe: 136 },
		abilities: { 0: "Royal Sun" },
		heightm: 1.5,
		weightkg: 93.3,
		color: "Brown",
		eggGroups: ["Field"],
	...
	floetteeternal: {
		...
		abilities: { 0: "Symbiosis", 1: "Magic Guard", H: "Eternal Flower" },
		heightm: 0.2,
		weightkg: 0.9,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	gogoat: {
		...
		abilities: { 0: "Sap Sipper", 1: "Unaware", H: "Grass Pelt" },
		heightm: 1.7,
		weightkg: 91,
		color: "Brown",
		prevo: "Skiddo",
	...
	furfrou: {
		...
		abilities: { 0: "Fur Coat", 1: "Scrappy", H: "Friend Guard" },
		heightm: 1.2,
		weightkg: 28,
		color: "White",
		eggGroups: ["Field"],
	...
	furfrouheart: {
		...
		types: ["Normal", "Psychic"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 65, spd: 100, spe: 112 },
		abilities: { 0: "Fur Coat", 1: "Magic Guard", H: "Neutralization" },
		heightm: 1.2,
		weightkg: 28,
		color: "Red",
		eggGroups: ["Field"],
	...
	furfroustar: {
		...
		types: ["Normal", "Electric"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 65, spd: 100, spe: 112 },
		abilities: { 0: "Lightning Rod", 1: "Volt Absorb" },
		heightm: 1.2,
		weightkg: 28,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	furfroudiamond: {
		...
		types: ["Normal", "Rock"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 65, spd: 100, spe: 112 },
		abilities: { 0: "Fur Coat", 1: "Solid Rock", H: "Sheer Force" },
		heightm: 1.2,
		weightkg: 28,
		color: "Brown",
		eggGroups: ["Field"],
	...
	furfroudebutante: {
		...
		types: ["Normal", "Fairy"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 65, spd: 100, spe: 112 },
		abilities: { 0: "Fur Coat", 1: "Pastel Veil", H: "Misty Surge" },
		heightm: 1.2,
		weightkg: 28,
		color: "Pink",
		eggGroups: ["Field"],
	...
	furfroumatron: {
		...
		types: ["Normal", "Poison"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 65, spd: 100, spe: 112 },
		abilities: { 0: "Fur Coat", 1: "Corrosion", H: "Merciless" },
		heightm: 1.2,
		weightkg: 28,
		color: "Purple",
		eggGroups: ["Field"],
	...
	furfroudandy: {
		...
		types: ["Normal", "Dark"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 65, spd: 100, spe: 112 },
		abilities: { 0: "Fur Coat", 1: "Intimidate", H: "Stakeout" },
		heightm: 1.2,
		weightkg: 28,
		color: "Black",
		eggGroups: ["Field"],
	...
	furfroulareine: {
		...
		types: ["Normal", "Water"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 65, spd: 100, spe: 112 },
		abilities: { 0: "Fur Coat", 1: "Swift Swim", H: "Queenly Majesty" },
		heightm: 1.2,
		weightkg: 28,
		color: "Blue",
		eggGroups: ["Field"],
	...
	furfroupharaoh: {
		...
		types: ["Normal", "Ghost"],
		baseStats: { hp: 75, atk: 110, def: 80, spa: 65, spd: 100, spe: 112 },
		abilities: { 0: "Fur Coat", 1: "Shadow Shield", H: "Cursed Body" },
		heightm: 1.2,
		weightkg: 28,
		color: "Blue",
		eggGroups: ["Field"],
	...
	doublade: {
		...
		name: "Doublade",
		types: ["Steel", "Ghost"],
		baseStats: { hp: 85, atk: 110, def: 150, spa: 45, spd: 75, spe: 35 },
		abilities: { 0: "No Guard", 1: "Sharpness", H: "Dual Wield" },
		heightm: 0.8,
		weightkg: 4.5,
		color: "Brown",
		prevo: "Honedge",
	...
	aegislashblade: {
		...
		forme: "Blade",
		types: ["Steel", "Ghost"],
		baseStats: { hp: 80, atk: 150, def: 50, spa: 150, spd: 50, spe: 60 },
		abilities: { 0: "Stance Change" },
		heightm: 1.7,
		weightkg: 53,
		color: "Brown",
	...
	inkay: {
		...
		abilities: { 0: "Contrary", 1: "Neutralization", H: "Infiltrator" },
		heightm: 0.4,
		weightkg: 3.5,
		color: "Blue",
		evos: ["Malamar"],
	...
	dragalgemega: {
		...
		forme: "Mega",
		types: ["Poison", "Dragon"],
		baseStats: { hp: 85, atk: 107, def: 105, spa: 132, spd: 163, spe: 44 },
		abilities: { 0: "Toxic Renewal" },
		heightm: 2.1,
		weightkg: 100.3,
		color: "Brown",
		eggGroups: ["Water 1", "Dragon"],
	...
	heliolisk: {
		...
		baseStats: { hp: 62, atk: 50, def: 60, spa: 120, spd: 99, spe: 109 },
	...
	tyrantrum: {
		...
		types: ["Rock", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 82, atk: 140, def: 120, spa: 45, spd: 73, spe: 80 },
		abilities: { 0: "Tyrant Stream", 1: "Relic Armor", H: "Supreme Overlord" },
		heightm: 2.5,
		weightkg: 270,
		color: "Red",
		prevo: "Tyrunt",
	...
	tyrantrummega: {
		...
		types: ["Steel", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 82, atk: 170, def: 135, spa: 50, spd: 103, spe: 100 },
		abilities: { 0: "Tyrant Domain" },
		heightm: 2.5,
		weightkg: 270,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
	...
	aurorus: {
		...
		types: ["Rock", "Ice"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 123, atk: 47, def: 85, spa: 120, spd: 105, spe: 60 },
		abilities: { 0: "Refrigerate", 1: "Relic Armor", H: "Aurora Current" },
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
		prevo: "Amaura",
	...
	aurorusmega: {
		...
		types: ["Fairy", "Ice"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 123, atk: 47, def: 135, spa: 145, spd: 140, spe: 50 },
		abilities: { 0: "Aurora Domain" },
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
		eggGroups: ["Monster"],
	...
	goodra: {
		...
		abilities: { 0: "Regenerator", 1: "Gooey", H: "Poison Heal" },
		heightm: 2,
		weightkg: 150.5,
		color: "Purple",
		prevo: "Sliggoo",
	...
	goodrahisui: {
		...
		abilities: { 0: "Armorize", 1: "Filter", H: "Gooey" },
		heightm: 1.7,
		weightkg: 334.1,
		color: "Purple",
		prevo: "Sliggoo-Hisui",
		...
		evoCondition: "during rain",
		eggGroups: ["Dragon"],
		cosmeticFormes: ["Goodra-Hisui-Alt"],
		formeOrder: ["Goodra-Hisui", "Goodra-Hisui-Alt"],
	},
	goodrahisuialt: {
		isCosmeticForme: true,
		num: 706,
	...
	noivernmega: {"num":715,"name":"Noivern-Mega","baseSpecies":"Noivern","forme":"Mega","types":["Flying","Dragon"],"baseStats":{"hp":85,"atk":100,"def":80,"spa":127,"spd":90,"spe":153},"abilities":{"0":"Echo Sense"},"heightm":1.5,"weightkg":85,"color":"Purple","eggGroups":["Flying","Dragon"],"requiredItem":"Noivernite","battleOnly":"Noivern","isNonstandard":"Custom"},
	noivern: {
	...
	decidueye: {
		...
		abilities: { 0: "Fallen Star", 1: "Long Reach", H: "Tinted Lens" },
		heightm: 1.6,
		weightkg: 36.6,
		color: "Brown",
		prevo: "Dartrix",
		...
		formeOrder: ["Decidueye", "Decidueye-Hisui", "Decidueye-Alt"],
	},
	decidueyealt: {
		isCosmeticForme: true,
		name: "Decidueye-Alt",
	...
	toucannon: {
		...
		abilities: { 0: "Mega Launcher", 1: "Skill Link", H: "Bulletproof" },
		heightm: 1.1,
		weightkg: 26,
		color: "Black",
		prevo: "Trumbeak",
	...
	crabominablemega: {
		...
		forme: "Mega",
		types: ["Fighting", "Ice"],
		baseStats: { hp: 97, atk: 167, def: 132, spa: 62, spd: 127, spe: 33 },
		abilities: { 0: "Rime Knuckle" },
		heightm: 2.6,
		weightkg: 252.8,
		color: "White",
		eggGroups: ["Water 3"],
	...
	oricorio: {
		...
		types: ["Fire", "Flying"],
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 79, atk: 80, def: 75, spa: 98, spd: 75, spe: 93 },
		abilities: { 0: "Dancer", 1: "Opportunist", H: "Costar" },
		heightm: 0.6,
		weightkg: 3.4,
		color: "Red",
		eggGroups: ["Flying"],
	...
	lycanroc: {
		...
		baseForme: "Midday",
		types: ["Rock", "Ground"],
		baseStats: { hp: 75, atk: 120, def: 70, spa: 50, spd: 68, spe: 117 },
		abilities: { 0: "Earth Eater", 1: "Sand Rush", H: "Ultra Instinct" },
		heightm: 0.8,
		weightkg: 25,
		color: "Brown",
		prevo: "Rockruff",
	...
	lycanrocmidnight: {
		...
		forme: "Midnight",
		types: ["Rock", "Ghost"],
		baseStats: { hp: 85, atk: 120, def: 78, spa: 40, spd: 80, spe: 97 },
		abilities: { 0: "Ultra Ego", 1: "Shadow Shield", H: "No Guard" },
		heightm: 1.1,
		weightkg: 25,
		color: "Red",
		prevo: "Rockruff",
	...
	wishiwashi: {
		...
		baseForme: "Solo",
		types: ["Water"],
		baseStats: { hp: 80, atk: 20, def: 20, spa: 25, spd: 25, spe: 40 },
		abilities: { 0: "Schooling", 1: "Sevii Schooling" },
		heightm: 0.2,
		weightkg: 0.3,
		color: "Blue",
		eggGroups: ["Water 2"],
		otherFormes: ["Wishiwashi-School", "Wishiwashi-Sevii", "Wishiwashi-Sevii-Schooling"],
		formeOrder: ["Wishiwashi", "Wishiwashi-School", "Wishiwashi-Sevii", "Wishiwashi-Sevii-Schooling"],
	},
	wishiwashischool: {
		num: 746,
		...
		forme: "School",
		types: ["Water"],
		baseStats: { hp: 80, atk: 135, def: 130, spa: 135, spd: 130, spe: 60 },
	...
	wishiwashisevii: {
		...
		types: ["Ghost"],
		baseStats: { hp: 80, atk: 20, def: 20, spa: 25, spd: 25, spe: 40 },
		abilities: { 0: "Sevii Schooling" },
		heightm: 0.2,
		weightkg: 0.3,
		color: "Purple",
		eggGroups: ["Water 2"],
		requiredAbility: "Sevii Schooling",
		battleOnly: "Wishiwashi",
	},
	wishiwashiseviischooling: {
		num: 746,
		name: "Wishiwashi-Sevii-Schooling",
		baseSpecies: "Wishiwashi",
		forme: "Sevii-Schooling",
		types: ["Ghost", "Dragon"],
		baseStats: { hp: 80, atk: 135, def: 130, spa: 135, spd: 130, spe: 60 },
		abilities: { 0: "Sevii Schooling" },
		heightm: 8.2,
	...
	mareanie: {
		...
		abilities: { 0: "Merciless", 1: "Toxic Debris", H: "Regenerator" },
		heightm: 0.4,
		weightkg: 8,
		color: "Blue",
		evos: ["Toxapex"],
	...
	mudsdale: {
		...
		name: "Mudsdale",
		types: ["Ground", "Fighting"],
		baseStats: { hp: 120, atk: 140, def: 115, spa: 40, spd: 100, spe: 35 },
		abilities: { 0: "Stamina", 1: "Battle Armor", H: "Inner Focus" },
		heightm: 2.5,
		weightkg: 920,
		color: "Brown",
		prevo: "Mudbray",
	...
	fomantis: {
		...
		abilities: { 0: "Invigorate", H: "Contrary" },
		heightm: 0.3,
		weightkg: 1.5,
		color: "Pink",
		evos: ["Lurantis"],
	...
	lurantis: {
		...
		name: "Lurantis",
		types: ["Grass", "Fighting"],
		baseStats: { hp: 90, atk: 100, def: 95, spa: 60, spd: 90, spe: 96 },
		abilities: { 0: "Intimidate", 1: "Chlorophyll", H: "Contrary" },
		heightm: 0.9,
		weightkg: 18.5,
		color: "Pink",
		prevo: "Fomantis",
	...
	shiinotic: {
		...
		abilities: { 0: "Illuminate", 1: "Neutralization", H: "Rain Dish" },
		heightm: 1,
		weightkg: 11.5,
		color: "Purple",
		prevo: "Morelull",
	...
	salazzlemega: {
		...
		types: ["Poison", "Fire"],
		gender: "F",
		baseStats: { hp: 68, atk: 74, def: 70, spa: 148, spd: 80, spe: 140 },
	...
	bounsweet: {
		...
		abilities: { 0: "Invigorate", 1: "Oblivious", H: "Sweet Veil" },
		heightm: 0.3,
		weightkg: 3.2,
		color: "Purple",
		evos: ["Steenee"],
	...
	tsareena: {
		...
		evoMove: "Stomp",
		eggGroups: ["Grass"],
		cosmeticFormes: ["Tsareena-Alt"],
		formeOrder: ["Tsareena", "Tsareena-Alt"],
	},
	tsareenaalt: {
		isCosmeticForme: true,
		num: 763,
	...
	oranguru: {
		...
		abilities: { 0: "Inner Focus", 1: "Primal Tactics", H: "Symbiosis" },
		heightm: 1.5,
		weightkg: 76,
		color: "White",
		eggGroups: ["Field"],
	...
	wimpod: {
		...
		abilities: { 0: "Wimp Out", 1: "Rattled", H: "Run Away" },
		heightm: 0.5,
		weightkg: 12,
		color: "Gray",
		evos: ["Golisopod"],
	...
	golisopod: {
		...
		abilities: { 0: "Emergency Exit", 1: "Inner Focus", H: "Shell Armor" },
		heightm: 2,
		weightkg: 108,
		color: "Gray",
		prevo: "Wimpod",
	...
	golisopodaevian: {
		...
		abilities: { 0: "Battle Armor", 1: "Skill Link", H: "Sand Stream" },
		heightm: 2,
		weightkg: 108,
		color: "Brown",
		eggGroups: ["Bug", "Water 3"],
		otherFormes: ["Golisopod-Aevian-Mega"],
		formeOrder: ["Golisopod-Aevian", "Golisopod-Aevian-Mega"],
		standalone: true,
		isNonstandard: "Custom",
	},
	golisopodmega: {
	...
	golisopodaevianmega: {
		num: 768,
		name: "Golisopod-Aevian-Mega",
		baseSpecies: "Golisopod-Aevian",
		forme: "Mega-Aevian",
		spriteid: "golisopod-aevian-mega",
		types: ["Bug", "Ground"],
		baseStats: { hp: 75, atk: 160, def: 155, spa: 60, spd: 140, spe: 40 },
		abilities: { 0: "Desert Shell" },
		heightm: 2.3,
		weightkg: 148,
		color: "Brown",
		eggGroups: ["Bug", "Water 3"],
		requiredItem: "Golisopite",
		battleOnly: "Golisopod-Aevian",
		changesFrom: "Golisopod-Aevian",
		gen: 9,
		isNonstandard: "Custom",
	},
	sandygast: {
	...
	palossand: {
		...
		abilities: { 0: "Water Compaction", 1: "Storm Drain", H: "Perish Body" },
		heightm: 1.3,
		weightkg: 250,
		color: "Brown",
		prevo: "Sandygast",
	...
	minior: {
		...
		types: ["Rock", "Flying"],
		gender: "N",
		baseStats: { hp: 80, atk: 115, def: 60, spa: 115, spd: 60, spe: 120 },
	...
	miniormeteor: {
		...
		types: ["Rock", "Flying"],
		gender: "N",
		baseStats: { hp: 80, atk: 60, def: 115, spa: 60, spd: 115, spe: 60 },
		abilities: { 0: "Shields Down" },
		heightm: 0.3,
		weightkg: 40,
		color: "Brown",
	...
	turtonator: {
		...
		name: "Turtonator",
		types: ["Fire", "Dragon"],
		baseStats: { hp: 80, atk: 80, def: 135, spa: 80, spd: 90, spe: 36 },
		abilities: { 0: "Shell Armor", 1: "Stamina", H: "Bulletproof", S: "Aevian Glacier" },
		heightm: 2,
		weightkg: 212,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["Turtonator-Rejuv"],
		formeOrder: ["Turtonator", "Turtonator-Rejuv"],
	},
	turtonatorrejuv: {
		num: 776,
		name: "Turtonator-Rejuv",
		baseSpecies: "Turtonator",
		forme: "Rejuv",
		types: ["Ice", "Dragon"],
		baseStats: { hp: 80, atk: 110, def: 130, spa: 25, spd: 120, spe: 36 },
		abilities: { 0: "Aevian Glacier" },
		heightm: 2,
		weightkg: 212,
		color: "Blue",
		eggGroups: ["Monster", "Dragon"],
		requiredAbility: "Aevian Glacier",
		battleOnly: "Turtonator",
		isNonstandard: "Custom",
	},
	togedemaru: {
		num: 777,
	...
	mimikyu: {
		...
		baseForme: "Disguised",
		types: ["Ghost", "Fairy"],
		baseStats: { hp: 55, atk: 90, def: 80, spa: 90, spd: 105, spe: 96 },
	...
	drampa: {
		...
		name: "Drampa",
		types: ["Normal", "Dragon"],
		baseStats: { hp: 78, atk: 60, def: 90, spa: 135, spd: 106, spe: 36 },
	...
	drampamega: {
		...
		forme: "Mega",
		types: ["Normal", "Dragon"],
		baseStats: { hp: 78, atk: 95, def: 110, spa: 160, spd: 126, spe: 36 },
		abilities: { 0: "Rain Sovereign" },
		heightm: 3,
		weightkg: 185,
		color: "White",
		eggGroups: ["Monster", "Dragon"],
	...
	dhelmise: {
		...
		types: ["Ghost", "Grass"],
		gender: "N",
		baseStats: { hp: 85, atk: 135, def: 110, spa: 60, spd: 100, spe: 40 },
	...
	melmetalgmax: {
		...
		types: ["Steel"],
		gender: "N",
		baseStats: { hp: 203, atk: 143, def: 143, spa: 80, spd: 65, spe: 34 },
	...
	rillaboom: {
		...
		abilities: { 0: "Violent Rush", 1: "Soundproof", H: "Grassy Surge" },
		heightm: 2.1,
		weightkg: 90,
		color: "Green",
		prevo: "Thwackey",
	...
	rillaboomgmax: {
		...
		types: ["Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 150, atk: 125, def: 90, spa: 60, spd: 70, spe: 85 },
		abilities: { 0: "Forest Surge" },
		heightm: 28,
		weightkg: 0,
		color: "Green",
		eggGroups: ["Field", "Grass"],
	...
	cinderacegmax: {
		...
		types: ["Fire"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 136, atk: 116, def: 75, spa: 65, spd: 75, spe: 119 },
		abilities: { 0: "Striker's Momentum" },
		heightm: 27,
		weightkg: 0,
		color: "White",
		eggGroups: ["Field", "Human-Like"],
	...
	inteleongmax: {
		...
		types: ["Water"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 105, atk: 85, def: 65, spa: 125, spd: 65, spe: 120 },
	...
	greedent: {
		...
		abilities: { 0: "Cheek Pouch", 1: "Accumulation", H: "Gluttony" },
		heightm: 0.6,
		weightkg: 6,
		color: "Brown",
		prevo: "Skwovet",
	...
	corviknight: {
		...
		name: "Corviknight",
		types: ["Flying", "Steel"],
		baseStats: { hp: 100, atk: 95, def: 115, spa: 40, spd: 90, spe: 70 },
		abilities: { 0: "Pressure", 1: "Sworn Duty", H: "Mirror Armor" },
		heightm: 2.2,
		weightkg: 75,
		color: "Purple",
		prevo: "Corvisquire",
	...
	corviknightgmax: {
		...
		forme: "Gmax",
		types: ["Flying", "Steel"],
		baseStats: { hp: 150, atk: 95, def: 115, spa: 40, spd: 90, spe: 70 },
		abilities: { 0: "Iron Dominion" },
		heightm: 14,
		weightkg: 0,
		color: "Purple",
		eggGroups: ["Flying"],
	...
	orbeetle: {
		...
		name: "Orbeetle",
		types: ["Bug", "Psychic"],
		baseStats: { hp: 60, atk: 45, def: 110, spa: 90, spd: 130, spe: 90 },
		abilities: { 0: "Magic Bounce", 1: "Psychic Surge", H: "Telepathy" },
		heightm: 0.4,
		weightkg: 40.8,
		color: "Red",
		prevo: "Dottler",
	...
	orbeetlegmax: {
		...
		forme: "Gmax",
		types: ["Bug", "Psychic"],
		baseStats: { hp: 120, atk: 45, def: 110, spa: 90, spd: 130, spe: 90 },
		abilities: { 0: "Astral Watcher" },
		heightm: 14,
		weightkg: 0,
		color: "Red",
		eggGroups: ["Bug"],
	...
	thievul: {
		...
		name: "Thievul",
		types: ["Normal", "Dark"],
		baseStats: { hp: 80, atk: 58, def: 63, spa: 102, spd: 97, spe: 115 },
		abilities: { 0: "Technician", 1: "Unburden", H: "Stakeout" },
		heightm: 1.2,
		weightkg: 19.9,
		color: "Brown",
		prevo: "Nickit",
	...
	eldegoss: {
		...
		name: "Eldegoss",
		types: ["Normal", "Grass"],
		baseStats: { hp: 60, atk: 50, def: 90, spa: 80, spd: 145, spe: 60 },
		abilities: { 0: "Windy Surge", 1: "Regenerator", H: "Effect Spore" },
		heightm: 0.5,
		weightkg: 2.5,
		color: "Green",
		prevo: "Gossifleur",
	...
	boltund: {
		...
		abilities: { 0: "Strong Jaw", 1: "Competitive", H: "Guard Dog" },
		heightm: 1,
		weightkg: 34,
		color: "Yellow",
		prevo: "Yamper",
	...
	coalossal: {
		...
		abilities: { 0: "Steam Engine", 1: "Flame Body", H: "Earth Eater" },
		heightm: 2.8,
		weightkg: 310.5,
		color: "Black",
		prevo: "Carkol",
	...
	coalossalgmax: {
		...
		forme: "Gmax",
		types: ["Rock", "Fire"],
		baseStats: { hp: 165, atk: 80, def: 120, spa: 80, spd: 90, spe: 30 },
		abilities: { 0: "Furnace Engine" },
		heightm: 42,
		weightkg: 0,
		color: "Black",
		eggGroups: ["Mineral"],
	...
	sandacondagmax: {
		...
		forme: "Gmax",
		types: ["Ground"],
		baseStats: { hp: 123, atk: 107, def: 125, spa: 65, spd: 70, spe: 71 },
		abilities: { 0: "Dune Terror" },
		heightm: 22,
		weightkg: 0,
		color: "Green",
		eggGroups: ["Field", "Dragon"],
	...
	cramorant: {
		...
		name: "Cramorant",
		types: ["Flying", "Water"],
		baseStats: { hp: 90, atk: 45, def: 95, spa: 85, spd: 115, spe: 90 },
	...
	toxtricity: {
		...
		evoLevel: 30,
		eggGroups: ["Human-Like"],
		otherFormes: ["Toxtricity-Low-Key", "Toxtricity-Aevian"],
		formeOrder: ["Toxtricity", "Toxtricity-Low-Key", "Toxtricity-Aevian"],
	...
	toxtricitylowkey: {
		...
		types: ["Dark", "Poison"],
		baseStats: { hp: 75, atk: 98, def: 70, spa: 114, spd: 70, spe: 75 },
		abilities: { 0: "Punk Rock", 1: "Dark Aura", H: "Technician" },
		heightm: 1.6,
		weightkg: 40,
		color: "Purple",
		prevo: "Toxel",
	...
	toxtricityaevian: {
		...
		forme: "Aevian",
		types: ["Fire", "Poison"],
		baseStats: { hp: 75, atk: 75, def: 70, spa: 115, spd: 70, spe: 97 },
		...
		eggGroups: ["Human-Like"],
		isNonstandard: "Custom",
		canGigantamax: "G-Max Flare Shock",
		otherFormes: ["Toxtricity-Aevian-Gmax"],
		formeOrder: ["Toxtricity-Aevian", "Toxtricity-Aevian-Gmax"],
	},
	toxtricityaeviangmax: {
		num: 849,
		name: "Toxtricity-Aevian-Gmax",
		baseSpecies: "Toxtricity-Aevian",
		forme: "Gmax",
		types: ["Fire", "Poison"],
		baseStats: { hp: 128, atk: 75, def: 70, spa: 115, spd: 70, spe: 97 },
		abilities: { 0: "Riot Amp" },
		heightm: 24,
		weightkg: 0,
		color: "Purple",
		eggGroups: ["Human-Like"],
		changesFrom: "Toxtricity-Aevian",
		isNonstandard: "Custom",
	},
	toxtricitygmax: {
		num: 849,
		...
		forme: "Gmax",
		types: ["Electric", "Poison"],
		baseStats: { hp: 128, atk: 98, def: 70, spa: 114, spd: 70, spe: 75 },
		abilities: { 0: "Riot Amp" },
		heightm: 24,
		weightkg: 0,
		color: "Purple",
	...
	centiskorchgmax: {
		...
		forme: "Gmax",
		types: ["Fire", "Bug"],
		baseStats: { hp: 150, atk: 115, def: 65, spa: 90, spd: 90, spe: 65 },
		abilities: { 0: "Heat Coil" },
		heightm: 75,
		weightkg: 0,
		color: "Red",
		eggGroups: ["Bug"],
	...
	grapploct: {
		...
		name: "Grapploct",
		types: ["Fighting", "Water"],
		baseStats: { hp: 80, atk: 128, def: 100, spa: 40, spd: 100, spe: 82 },
		abilities: { 0: "Contrary", 1: "Technician", H: "Prankster" },
		heightm: 1.6,
		weightkg: 39,
		color: "Blue",
		prevo: "Clobbopus",
	...
	polteageist: {
		...
		abilities: { 0: "Temporal Shift", 1: "Innards Out", H: "Hospitality" },
		heightm: 0.2,
		weightkg: 0.4,
		color: "Purple",
		prevo: "Sinistea",
	...
	polteageistantique: {
		...
		gender: "N",
		baseStats: { hp: 60, atk: 65, def: 65, spa: 134, spd: 114, spe: 70 },
		abilities: { 0: "Temporal Shift", H: "Hospitality" },
		heightm: 0.2,
		weightkg: 0.4,
		color: "Purple",
	...
	hatenna: {
		...
		abilities: { 0: "Invigorate", 1: "Anticipation", H: "Magic Bounce" },
		heightm: 0.4,
		weightkg: 3.4,
		color: "Pink",
		evos: ["Hattrem"],
	...
	hatterenegmax: {
		...
		types: ["Psychic", "Fairy"],
		gender: "F",
		baseStats: { hp: 114, atk: 90, def: 95, spa: 136, spd: 103, spe: 29 },
		abilities: { 0: "Bewitching Majesty" },
		heightm: 26,
		weightkg: 0,
		color: "Pink",
		eggGroups: ["Fairy"],
	...
	grimmsnarl: {
		...
		abilities: { 0: "Prankster", 1: "Tangling Hair", H: "Frisk" },
		heightm: 1.5,
		weightkg: 61,
		color: "Purple",
		prevo: "Morgrem",
		...
		otherFormes: ["Grimmsnarl-Gmax", "Grimmsnarl-Azzy"],
		cosmeticFormes: ["Grimmsnarl-Azzy"],
		formeOrder: ["Grimmsnarl", "Grimmsnarl-Gmax", "Grimmsnarl-Azzy"],
	},
	grimmsnarlazzy: {
		isCosmeticForme: true,
		num: 861,
	...
	grimmsnarlgmax: {
		...
		types: ["Dark", "Fairy"],
		gender: "M",
		baseStats: { hp: 143, atk: 120, def: 65, spa: 95, spd: 75, spe: 60 },
		abilities: { 0: "Wicked Snare" },
		heightm: 32,
		weightkg: 0,
		color: "Purple",
		eggGroups: ["Fairy", "Human-Like"],
		changesFrom: "Grimmsnarl",
		cosmeticFormes: ["Grimmsnarl-Gmax-Azzy"],
		formeOrder: ["Grimmsnarl-Gmax", "Grimmsnarl-Gmax-Azzy"],
	},
	grimmsnarlgmaxazzy: {
		isCosmeticForme: true,
		num: 861,
	...
	cursola: {
		...
		types: ["Ghost"],
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 60, atk: 95, def: 57, spa: 145, spd: 130, spe: 50 },
		abilities: { 0: "Weak Armor", 1: "Perish Body", H: "Temporal Shift" },
		heightm: 1,
		weightkg: 0.4,
		color: "White",
		prevo: "Corsola-Galar",
	...
	sirfetchd: {
		...
		abilities: { 0: "Royal Decree", 1: "Sharpness", H: "Scrappy" },
		heightm: 0.8,
		weightkg: 117,
		color: "White",
	...
	runerigus: {
		...
		name: "Runerigus",
		types: ["Ground", "Ghost"],
		baseStats: { hp: 75, atk: 115, def: 145, spa: 50, spd: 105, spe: 30 },
		abilities: { 0: "Wandering Spirit", 1: "Neutralization", H: "Shadow Shield" },
		heightm: 1.6,
		weightkg: 66.6,
		color: "Gray",
		prevo: "Yamask-Galar",
	...
	alcremiegmax: {
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: { hp: 130, atk: 60, def: 75, spa: 110, spd: 121, spe: 64 },
		abilities: { 0: "Sweet Sanctuary" },
		heightm: 30,
		weightkg: 0,
		color: "Yellow",
		eggGroups: ["Fairy", "Amorphous"],
	...
	indeedee: {
		...
		abilities: { 0: "Neutralization", 1: "Friend Guard", H: "Psychic Surge" },
		heightm: 0.9,
		weightkg: 28,
		color: "Purple",
		eggGroups: ["Fairy"],
	...
	morpeko: {
		...
		types: ["Electric", "Dark"],
		baseStats: { hp: 58, atk: 115, def: 58, spa: 70, spd: 58, spe: 107 },
	...
	copperajahgmax: {
		...
		forme: "Gmax",
		types: ["Steel"],
		baseStats: { hp: 183, atk: 130, def: 69, spa: 80, spd: 69, spe: 30 },
		abilities: { 0: "Treasure Titan" },
		heightm: 23,
		weightkg: 0,
		color: "Green",
		eggGroups: ["Field", "Mineral"],
	...
	dracozolt: {
		...
		abilities: { 0: "Relic Mishap", 1: "Hustle", H: "Sand Rush" },
		heightm: 1.8,
		weightkg: 190,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	arctozolt: {
		...
		abilities: { 0: "Relic Mishap", 1: "Static", H: "Slush Rush" },
		heightm: 2.3,
		weightkg: 150,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	dracovish: {
		...
		abilities: { 0: "Relic Mishap", 1: "Strong Jaw", H: "Sand Rush" },
		heightm: 2.3,
		weightkg: 215,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	arctovish: {
		...
		abilities: { 0: "Relic Mishap", 1: "Ice Body", H: "Slush Rush" },
		heightm: 2,
		weightkg: 175,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	duraludongmax: {
		...
		forme: "Gmax",
		types: ["Steel", "Dragon"],
		baseStats: { hp: 119, atk: 95, def: 115, spa: 120, spd: 50, spe: 85 },
		abilities: { 0: "Alloy Core" },
		heightm: 43,
		weightkg: 0,
		color: "White",
		eggGroups: ["Mineral", "Dragon"],
	...
	urshifugmax: {
		...
		types: ["Fighting", "Dark"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 150, atk: 130, def: 100, spa: 63, spd: 60, spe: 97 },
		abilities: { 0: "Guts" },
		heightm: 29,
		weightkg: 0,
		color: "Gray",
	...
	meowscarada: {
		...
		abilities: { 0: "Magician", 1: "Protean", H: "Illusion" },
		heightm: 1.5,
		weightkg: 31.2,
		color: "Green",
		prevo: "Floragato",
	...
	skeledirge: {
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		cosmeticFormes: ["Skeledirge-Alt"],
		formeOrder: ["Skeledirge", "Skeledirge-Alt"],
	},
	skeledirgealt: {
		isCosmeticForme: true,
		num: 911,
	...
	quaquaval: {
		...
		abilities: { 0: "Guts", 1: "Dancer", H: "Moxie" },
		heightm: 1.8,
		weightkg: 61.9,
		color: "Blue",
		prevo: "Quaxwell",
	...
	oinkologne: {
		...
		abilities: { 0: "Lingering Aroma", 1: "Gluttony", H: "Unaware" },
		heightm: 1,
		weightkg: 120,
		color: "Gray",
		prevo: "Lechonk",
	...
	pawmot: {
		...
		name: "Pawmot",
		types: ["Electric", "Fighting"],
		baseStats: { hp: 70, atk: 115, def: 70, spa: 70, spd: 60, spe: 115 },
		abilities: { 0: "Volt Absorb", 1: "Natural Cure", H: "Iron Fist" },
		heightm: 0.9,
		weightkg: 41,
		color: "Yellow",
	...
	dachsbun: {
		...
		name: "Dachsbun",
		types: ["Fairy"],
		baseStats: { hp: 80, atk: 80, def: 115, spa: 50, spd: 80, spe: 95 },
		abilities: { 0: "Well-Baked Body", 1: "Aroma Veil", H: "Friend Guard" },
		heightm: 0.5,
		weightkg: 14.9,
		color: "Brown",
		prevo: "Fidough",
	...
	arboliva: {
		...
		abilities: { 0: "Seed Sower", 1: "Hospitality", H: "Harvest" },
		heightm: 1.4,
		weightkg: 48.2,
		color: "Green",
		prevo: "Dolliv",
	...
	arbolivamega: {
		...
		forme: "Mega",
		types: ["Grass", "Normal"],
		baseStats: { hp: 78, atk: 69, def: 135, spa: 135, spd: 154, spe: 39 },
		abilities: { 0: "Verdant Sanctuary" },
		heightm: 1.4,
		weightkg: 48.2,
		color: "Green",
		eggGroups: ["Grass"],
	...
	ceruledge: {
		...
		abilities: { 0: "Soul Fire", 1: "Dual Wield", H: "Weak Armor" },
		heightm: 1.6,
		weightkg: 62,
		color: "Purple",
		prevo: "Charcadet",
	...
	belliboltmega: {
		...
		forme: "Mega",
		types: ["Electric"],
		baseStats: { hp: 119, atk: 74, def: 111, spa: 153, spd: 113, spe: 45 },
		abilities: { 0: "Bog Body" },
		heightm: 1.2,
		weightkg: 113,
		color: "Green",
		eggGroups: ["Water 1"],
	...
	kilowattrel: {
		...
		abilities: { 0: "Wind Power", 1: "Volt Absorb", H: "Storm Power" },
		heightm: 1.4,
		weightkg: 38.6,
		color: "Yellow",
		prevo: "Wattrel",
	...
	toedscruel: {
		...
		types: ["Ground", "Grass"],
		baseStats: { hp: 80, atk: 70, def: 75, spa: 90, spd: 120, spe: 105 },
		abilities: { 0: "Mycelium Might", 1: "Liquid Ooze", H: "Rain Dish" },
		heightm: 1.9,
		weightkg: 58,
		color: "Black",
		prevo: "Toedscool",
	...
	rabsca: {
		...
		name: "Rabsca",
		types: ["Bug", "Psychic"],
		baseStats: { hp: 100, atk: 50, def: 90, spa: 120, spd: 100, spe: 60 },
		abilities: { 0: "Sand Rush", 1: "Elevate", H: "Telepathy" },
		heightm: 0.3,
		weightkg: 3.5,
		color: "Green",
		prevo: "Rellor",
	...
	tinkaton: {
		...
		abilities: { 0: "Mold Breaker", 1: "Own Tempo", H: "Steely Spirit" },
		heightm: 0.7,
		weightkg: 112.8,
		color: "Pink",
		prevo: "Tinkatuff",
	...
	wugtrio: {
		...
		types: ["Water"],
		baseStats: { hp: 35, atk: 100, def: 50, spa: 50, spd: 70, spe: 120 },
		abilities: { 0: "Gooey", 1: "Rattled", H: "Hydra Bond" },
		heightm: 1.2,
		weightkg: 5.4,
		color: "Red",
		prevo: "Wiglett",
	...
	bombirdier: {
		...
		name: "Bombirdier",
		types: ["Flying", "Dark"],
		baseStats: { hp: 70, atk: 103, def: 85, spa: 50, spd: 85, spe: 97 },
		abilities: { 0: "Unburden", 1: "Pressure", H: "Rocky Payload" },
		heightm: 1.5,
		weightkg: 42.9,
		color: "White",
		eggGroups: ["Flying"],
	...
	cyclizar: {
		...
		name: "Cyclizar",
		types: ["Dragon", "Normal"],
		baseStats: { hp: 70, atk: 95, def: 65, spa: 95, spd: 65, spe: 121 },
		abilities: { 0: "Shed Skin", 1: "Regenerator", H: "Paradox Engine" },
		heightm: 1.6,
		weightkg: 63,
		color: "Green",
		eggGroups: ["Field"],
	...
	glimmet: {
		...
		abilities: { 0: "Toxic Debris", 1: "Corrosion", H: "Memory Leak" },
		heightm: 0.7,
		weightkg: 8,
		color: "Blue",
		evos: ["Glimmora"],
	...
	glimmoramega: {
		...
		abilities: { 0: "Terastal Adaptability" },
		heightm: 2.8,
		weightkg: 77,
		color: "Blue",
		eggGroups: ["Mineral"],
	...
	glimmoraaevian: {
		num: 970,
		name: "Glimmora-Aevian",
		forme: "Aevian",
		types: ["Steel", "Flying"],
		baseStats: { hp: 83, atk: 55, def: 90, spa: 130, spd: 81, spe: 86 },
		abilities: { 0: "Memory Leak", 1: "Download", H: "Filter" },
		heightm: 1.5,
		weightkg: 45,
		color: "Black",
		eggGroups: ["Mineral"],
		otherFormes: ["Glimmora-Aevian-Mega"],
		formeOrder: ["Glimmora-Aevian", "Glimmora-Aevian-Mega"],
		standalone: true,
		isNonstandard: "Custom",
	},
	glimmoraaevianmega: {
		num: 970,
		name: "Glimmora-Aevian-Mega",
		baseSpecies: "Glimmora-Aevian",
		forme: "Mega-Aevian",
		spriteid: "glimmora-aevian-mega",
		types: ["Steel", "Flying"],
		baseStats: { hp: 83, atk: 65, def: 110, spa: 160, spd: 111, spe: 96 },
		abilities: { 0: "Adaptive Core" },
		heightm: 2.8,
		weightkg: 77,
		color: "Black",
		eggGroups: ["Mineral"],
		requiredItem: "Glimmoranite",
		battleOnly: "Glimmora-Aevian",
		changesFrom: "Glimmora-Aevian",
		isNonstandard: "Custom",
	},
	greavard: {
		num: 971,
	...
	houndstone: {
		...
		abilities: { 0: "Sand Rush", 1: "Slush Rush", H: "Fluffy" },
		heightm: 2,
		weightkg: 15,
		color: "White",
		prevo: "Greavard",
	...
	veluza: {
		...
		abilities: { 0: "Mold Breaker", 1: "Swift Swim", H: "Sharpness", S: "Aevian Rocket" },
		heightm: 2.5,
		weightkg: 90,
		color: "Gray",
		eggGroups: ["Water 2"],
		otherFormes: ["Veluza-Rejuv"],
		formeOrder: ["Veluza", "Veluza-Rejuv"],
	},
	veluzarejuv: {
		num: 976,
		name: "Veluza-Rejuv",
		...
		abilities: { 0: "Aevian Rocket" },
		heightm: 2.5,
		weightkg: 90,
		color: "Gray",
		eggGroups: ["Water 2"],
		requiredAbility: "Aevian Rocket",
		battleOnly: "Veluza",
		isNonstandard: "Custom",
	},
	dondozo: {
	...
	annihilape: {
		...
		baseStats: { hp: 110, atk: 120, def: 85, spa: 50, spd: 95, spe: 90 },
	...
	embirch: {
		...
		abilities: { 0: "Reckless", 1: "Invigorate", H: "Chlorophyll" },
		heightm: 0.6,
		weightkg: 15,
		color: "Brown",
		evos: ["Flarelm"],
	...
	shox: {
		...
		abilities: { 0: "Electromorphosis", 1: "Sticky Hold", H: "Gluttony" },
		heightm: 3,
		weightkg: 99.9,
		color: "Brown",
		eggGroups: ["Field"],
...
const latestSpeciesUpdates: {[id: string]: any} = {
	breloom: {
		baseStats: {"hp":80,"atk":130,"def":80,"spa":60,"spd":80,"spe":70},
		abilities: {0: "Technician", 1: "Poison Heal", H: "Guts", S: "Aevian Spark"},
	},
	azumarill: {
	...
	hippowdon: {
		...
		abilities: {0: "Sand Stream", 1: "Ruin Jaw", H: "Accumulation"},
	},
	...
	mightyenadeso: {baseStats: {hp: 90, atk: 125, def: 85, spa: 60, spd: 80, spe: 125}},
	cinccino: {baseStats: {hp: 75, atk: 110, def: 85, spa: 70, spd: 85, spe: 125}},
	cinccinodeso: {baseStats: {hp: 75, atk: 110, def: 100, spa: 60, spd: 100, spe: 125}},
	...
	lumineon: {baseStats: {hp: 89, atk: 40, def: 86, spa: 104, spd: 90, spe: 91}},
	...
	typhlosion: {baseStats: {hp: 83, atk: 95, def: 85, spa: 112, spd: 70, spe: 100}},
	typhlosionhisui: {baseStats: {hp: 83, atk: 95, def: 80, spa: 127, spd: 65, spe: 95}},
...
const customVisualFormes = new Set(['Alt', 'Aevian', 'East-Aevian', 'Pulse', 'Azzy', 'Azzy2', 'Rejuv', 'Reborn', 'Deso', 'Spring', 'Summer', 'Autumn', 'Winter', 'Rocky', 'Fiery', 'Icy']);
...
for (const [id, rawSpecies] of Object.entries(Pokedex)) {
	...
	if (species.standalone) continue;
	...
	if (!species.cannotDynamax && species.canGigantamax === undefined && base.canGigantamax && !String(species.forme || '').toLowerCase().includes('mega')) {
