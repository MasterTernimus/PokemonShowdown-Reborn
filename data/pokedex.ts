export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	charizard: {
		...
		abilities: { 0: "Intimidate", 1: "Battle Fervor", H: "Solar Power" },
		heightm: 1.7,
		weightkg: 90.5,
		color: "Red",
		prevo: "Charmeleon",
	...
	butterfreegmax: {
		...
		forme: "Gmax",
		types: ["Bug", "Fairy"],
		baseStats: { hp: 120, atk: 45, def: 50, spa: 90, spd: 80, spe: 70 },
	...
	infernape: {
		...
		abilities: { 0: "Blaze", 1: "Ultra Instinct", H: "Iron Fist" },
		heightm: 1.2,
		weightkg: 55,
		color: "Brown",
		prevo: "Monferno",
	...
	empoleon: {
		...
		abilities: { 0: "Royal Decree", 1: "Defiant", H: "Competitive" },
		heightm: 1.7,
		weightkg: 84.5,
		color: "Blue",
		prevo: "Prinplup",
	...
	decidueyehisui: {
		...
		abilities: { 0: "Overgrow", 1: "Striker", H: "Scrappy" },
		heightm: 1.6,
		weightkg: 37,
		color: "Brown",
		prevo: "Dartrix",
