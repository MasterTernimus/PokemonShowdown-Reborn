export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	beartic: {
		...
		name: "Beartic",
		types: ["Ice", "Dark"],
		baseStats: { hp: 110, atk: 130, def: 85, spa: 70, spd: 80, spe: 65 },
...
const customVisualFormes = new Set(['Alt', 'Aevian', 'East-Aevian', 'Pulse', 'Azzy', 'Azzy2', 'Spring', 'Summer', 'Autumn', 'Winter']);
