export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	muk: {
		...
		name: "Muk",
		types: ["Poison", "Ghost"],
		baseStats: { hp: 105, atk: 105, def: 75, spa: 98, spd: 157, spe: 30 },
		abilities: { 0: "Toxic Mess", 1: "Adaptive Waste", H: "Accumulation" },
		heightm: 1.2,
		weightkg: 30,
		color: "Purple",
		prevo: "Grimer",
	...
	corsola: {
		...
		color: "Pink",
		eggGroups: ["Water 1", "Water 3"],
		otherFormes: ["Corsola-Galar", "Corsola-Alt"],
		cosmeticFormes: ["Corsola-Alt"],
		formeOrder: ["Corsola", "Corsola-Galar", "Corsola-Alt"],
	},
	corsolagalar: {
		num: 222,
		name: "Corsola-Galar",
	...
	zangoose: {
		...
		name: "Zangoose",
		types: ["Normal", "Steel"],
		baseStats: { hp: 105, atk: 135, def: 85, spa: 60, spd: 90, spe: 95 },
...
const customVisualFormes = new Set(['Alt', 'Aevian', 'East-Aevian', 'Pulse', 'Azzy', 'Azzy2', 'Rejuv', 'Deso', 'Spring', 'Summer', 'Autumn', 'Winter']);
