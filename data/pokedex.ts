export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	blastoisegmax: {
		...
		types: ["Water", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 135, atk: 83, def: 100, spa: 85, spd: 105, spe: 78 },
	...
	arcanine: {
		...
		abilities: { 0: "Intimidate", 1: "Flash Fire", H: "Drought" },
		heightm: 1.9,
		weightkg: 155,
		color: "Brown",
		prevo: "Growlithe",
	...
	houndoom: {
		...
		abilities: { 0: "Insomnia", 1: "Dark Aura", H: "Battle Fervor" },
		heightm: 1.4,
		weightkg: 35,
		color: "Black",
		prevo: "Houndour",
	...
	garchomp: {
		...
		abilities: { 0: "Mold Breaker", 1: "Rough Skin", H: "Battle Fervor" },
		heightm: 1.9,
		weightkg: 95,
		color: "Blue",
		prevo: "Gabite",
