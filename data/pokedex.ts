export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	butterfree: {
		...
		abilities: { 0: "Compound Eyes", 1: "Shield Dust", H: "Corrosive Dust" },
		heightm: 1.1,
		weightkg: 32,
		color: "White",
		prevo: "Metapod",
	...
	banette: {
		...
		name: "Banette",
		types: ["Ghost", "Normal"],
		baseStats: { hp: 64, atk: 125, def: 85, spa: 60, spd: 63, spe: 83 },
	...
	banettemega: {
		...
		forme: "Mega",
		types: ["Ghost", "Normal"],
		baseStats: { hp: 64, atk: 165, def: 110, spa: 50, spd: 93, spe: 103 },
	...
	honchkrow: {
		...
		abilities: { 0: "Pressure", 1: "Royal Decree", H: "Serene Grace" },
		heightm: 0.9,
		weightkg: 27.3,
		color: "Black",
		prevo: "Murkrow",
