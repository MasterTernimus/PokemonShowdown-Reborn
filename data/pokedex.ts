export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	parasect: {
		...
		evoLevel: 24,
		eggGroups: ["Bug", "Grass"],
		otherFormes: ["Parasect-Mega", "Parasect-Aevian", "Parasect-Parasite"],
	},
	parasectparasite: {
		num: 47,
	...
	gyarados: {
		...
		name: "Gyarados",
		types: ["Water", "Flying"],
		baseStats: { hp: 95, atk: 130, def: 95, spa: 80, spd: 119, spe: 81 },
	...
	gyaradosmega: {
		...
		forme: "Mega",
		types: ["Water", "Dark"],
		baseStats: { hp: 95, atk: 160, def: 125, spa: 90, spd: 149, spe: 81 },
