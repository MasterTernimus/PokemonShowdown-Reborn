export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	sandslash: {
		...
		name: "Sandslash",
		types: ["Ground", "Bug"],
		baseStats: { hp: 95, atk: 125, def: 135, spa: 45, spd: 75, spe: 85 },
	...
	pinsir: {
		...
		abilities: { 0: "Hyper Cutter", 1: "Ironclad", H: "Violent Rush" },
		heightm: 1.5,
		weightkg: 55,
		color: "Brown",
		eggGroups: ["Bug"],
	...
	palossand: {
		...
		name: "Palossand",
		types: ["Ghost", "Ground"],
		baseStats: { hp: 115, atk: 55, def: 75, spa: 135, spd: 115, spe: 55 },
