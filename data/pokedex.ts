export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	charizardmegax: {
		...
		types: ["Fire", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 78, atk: 135, def: 125, spa: 70, spd: 121, spe: 105 },
	...
	spiritomb: {
		...
		abilities: { 0: "Intimidate", 1: "Shadow Shield", H: "Pressure" },
		heightm: 1,
		weightkg: 108,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	chandelure: {
		...
		abilities: { 0: "Flash Fire", 1: "Flame Body", H: "Soul Fire" },
		heightm: 1,
		weightkg: 34.3,
		color: "Black",
		prevo: "Lampent",
