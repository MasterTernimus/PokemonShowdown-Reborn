...
class DexConditions {
  ...
  getByID(id) {
    ...
    } else if (this.dex.data.Moves.hasOwnProperty(id) && (found = this.dex.data.Moves[id]).condition || this.dex.data.Abilities.hasOwnProperty(id) && (found = this.dex.data.Abilities[id]).condition || this.dex.data.Items.hasOwnProperty(id) && (found = this.dex.data.Items[id]).condition || this.dex.data.Terrains.hasOwnProperty(id) && (found = this.dex.data.Terrains[id]).condition) {
