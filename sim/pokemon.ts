	...
	*/
	...
	hasAbility(ability: string | string[]) {
		const abilityAliases: { [abilityid: string]: string[] } = {
			apexpredator: ['relicarmor', 'precision'],
			...
			treasuretitan: ['filter', 'eartheater'],
			...
			freezerburn: ['slushrush', 'icebody', 'refrigerate'],
