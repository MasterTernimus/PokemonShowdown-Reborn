	...
	*/
	...
	hasAbility(ability: string | string[]) {
		const abilityAliases: { [abilityid: string]: string[] } = {
			...
			aquashell: ['waterbubble', 'waterveil', 'toughclaws', 'shellarmor'],
			...
			aurainstinct: ['swornduty'],
			wrathshield: ['swornduty'],
			shadowcurrent: ['swornduty', 'infiltrator'],
			astralwitchcraft: ['levitate', 'magicguard', 'magicbounce', 'swornduty'],
			...
			hydratyrant: ['hydrabond', 'selfsufficient', 'precision'],
			...
			relicarmor: ['pressure', 'rockhead', 'moldbreaker'],
