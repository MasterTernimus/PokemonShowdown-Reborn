...
const DATA_TYPES: (DataType | 'Aliases')[] = [
	'Abilities', 'Rulesets', 'FormatsData', 'Items', 'Learnsets', 'Moves', 'Terrains',
...
export class ModdedDex {
	...
	constructor(mod = 'base') {
		...
		this.terrains = new DexTerrains(this);
...
export namespace Dex {
	...
	export type Terrain = import('./dex-terrains').Terrain;
