...
type TerrainData = import('./dex-terrains').TerrainData;
type Terrain = import('./dex-terrains').Terrain;
...
interface ModdedBattlePokemon {
	...
	runImmunity?: (this: Pokemon, type: string | string[], message?: string | boolean) => boolean;
	setAbility?: (
...
interface TerrainText extends TextFile { }
